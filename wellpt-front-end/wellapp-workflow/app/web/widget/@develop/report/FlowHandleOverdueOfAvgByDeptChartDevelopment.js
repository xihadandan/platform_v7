...
class FlowHandleOverdueOfAvgByDeptChartDevelopment extends FlowChartDevelopmentBase {

  get META() {
    return {
      name: '流程统计分析_办理逾期分析_部门平均逾期时长',
      hook: {
        itemClick: '查看详情',
      }
    }
    ...
    options.toolbox = {
      feature: {
        myTool1: {
          ...
          onclick: function () {
            _this.getPageContext().emitEvent('bZRNsUDMxuRzNTuvpuVlozHkNIXCZGzR:showDrawer', {
              eventParams: {
                ..._this.$widget.params,
...
export default FlowHandleOverdueOfAvgByDeptChartDevelopment;
