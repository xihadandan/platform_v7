define([ "jquery", "commons", "constant", "server", "WorkFlowListViewWidgetDevelopmentBase" ], function($, commons,
	...
	// 平台应用_工作流程_工作已阅_视图组件二开
	var WorkFlowReadListViewWidgetDevelopment = function() {
		WorkFlowListViewWidgetDevelopmentBase.apply(this, arguments);
	};
	commons.inherit(WorkFlowReadListViewWidgetDevelopment, WorkFlowListViewWidgetDevelopmentBase, {
		getWorkViewUrl : function(index, row) {
			var url = ctx + "/workflow/work/v53/view/read?taskInstUuid={0}&flowInstUuid={1}";
	...
	return WorkFlowReadListViewWidgetDevelopment;
});