...
$(function() {
	...
	$("#list").jqGrid(
			{
				url : ctx + '/common/jqgrid/query?serviceName=workReadService',
				mtype : 'POST',
				datatype : "json",
				...
				ondblClickRow : function(id) {
					...
					if (rowData.flowInstUuid != null && rowData.flowInstUuid != "") {
						window.open(ctx + "/workflow/work/view/read?flowInstUuid=" + rowData["flowInstUuid"],
								"_blank");
					}
				},
	...
	$("#btn_todo_view").click(function() {
		...
		window.open(ctx + "/workflow/work/view/read?flowInstUuid=" + bean["flowInstUuid"], "_blank");
	});
