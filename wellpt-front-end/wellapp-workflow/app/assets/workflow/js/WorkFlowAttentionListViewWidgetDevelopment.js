define([ "jquery", "commons", "constant", "server", "WorkFlowListViewWidgetDevelopmentBase" ], function($, commons,
	...
	// 平台应用_工作流程_工作关注_视图组件二开
	var WorkFlowAttentionListViewWidgetDevelopment = function() {
		WorkFlowListViewWidgetDevelopmentBase.apply(this, arguments);
	};
	commons.inherit(WorkFlowAttentionListViewWidgetDevelopment, WorkFlowListViewWidgetDevelopmentBase, {
		getWorkViewUrl : function(index, row) {
			var url = ctx + "/workflow/work/v53/view/attention?taskInstUuid={0}&flowInstUuid={1}";
	...
	return WorkFlowAttentionListViewWidgetDevelopment;
});