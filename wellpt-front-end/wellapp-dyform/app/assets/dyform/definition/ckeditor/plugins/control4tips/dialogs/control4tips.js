            ...
            contents: [{
                ...
                elements: [
					{	id:"setForm",
                    	type:"html",
                    	style: "width: 100%;",
                    	html:"<div id='" + containerID + "'>提示设置</div>",
...
//					        }, 100); 
            ...
            onCancel: function(){//退出窗口时清空属性窗口的缓存 
            	...
            	if( (typeof tips.exitDialog) != "undefined"){
            		tips.exitDialog(); 
            	}
            } ,
            onShow:function(){
            	var focusedDomPropertyUrl = editor.focusedDomPropertyUrl4Tips;
            	$("#" + containerID).load(focusedDomPropertyUrl, function(){
            		tips.initPropertyDialog(editor);//初始化属性窗口
