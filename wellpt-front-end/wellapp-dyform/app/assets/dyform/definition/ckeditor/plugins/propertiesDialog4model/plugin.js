(function () {
  ...
  CKEDITOR.plugins.add(pluginName, {
    requires: ['dialog'],
    init: function (a) {
      a.propertiesDialog4ModelURL = CKEDITOR.plugins.basePath + pluginName + '/' + 'dialogs/' + pluginName + '.html'; //属性窗口中的html对应的地址,dysubform.js中要使用到该变量

      // a.imageOfDatectl = (CKEDITOR.plugins.basePath + pluginName + "/")+ "images/properties.bmp" ;
