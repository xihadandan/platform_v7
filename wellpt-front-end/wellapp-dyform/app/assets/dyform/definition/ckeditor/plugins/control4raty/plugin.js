...
$.extend(controlConfig, {
	...
	collectFormAndFillCkeditor:function(){
		...
		field.inputMode =  dyFormInputMode.number; //TODO  这里有bug, 应该换成不一样的值，不然在编辑时会进入到数字控件的属性弹出框中 
		//控件公共属性收集
...
controlConfig.pluginName = CkPlugin.RATY;
addPlugin(controlConfig.pluginName, "星级评分控件", "星级评分控件属性设置", controlConfig);
