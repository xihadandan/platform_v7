...
<head>
    ...
    <script type="text/javascript">
        ...
        function LoadPublishAddons() {
            var addonList = document.getElementById("addonList");
            var curList = [{"name":"WpsOAAssist","addonType":"wps","online":"true","url":"http://127.0.0.1:3888/plugin/wps/"},{"name":"WppOAAssist","addonType":"wpp","online":"true","url":"http://127.0.0.1:3888/plugin/wpp/"},{"name":"EtOAAssist","addonType":"et","online":"true","url":"http://127.0.0.1:3888/plugin/et/"}];
            curList.forEach(function (element) {
                var param = JSON.stringify(element).replace("\"", "\'");
                UpdateElement(element, 'enable')
            });
        }
        function LoadPublishAddons2() {
        	$.get("${ctx}/office/wps/v2/jsplugins.xml", function(doc){
        		var $doc = $(doc);
	            $doc.find("jsplugins>jspluginonline,jsplugins>jsplugin").each(function (idx, element) {
	                ...
	                UpdateElement(elementObj, 'enable')
	            });
        	});
        }
        function LoadAddons() {
            ...
            LoadPublishAddons2();// LoadPublishAddons();
            LoadLocalAddons();
        }
