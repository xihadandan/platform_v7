(function (global, factory) {
    ...
    function _runParams(suffix,params) {
        ...
        var browserInWPS = typeof wps === 'object' && typeof wps.WpsApplication === 'function' && typeof wps.ExecFunc === 'function';
        if(browserInWPS){
            wps.ExecFunc(`dispatcher(JSON.parse('${JSON.stringify(startData.info)}'))`);
        }else{
            switch (suffix) {
                case "wps":
