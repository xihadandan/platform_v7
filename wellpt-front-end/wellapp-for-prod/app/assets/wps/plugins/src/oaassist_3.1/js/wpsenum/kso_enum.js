     ...
     var MsoPresetLightingDirection = {
     ...
     var MsoPresetExtrusionDirection = {
     ...
     var MsoHorizontalAnchor = {
         msoHorizontalAnchorMixed: -2,
         msoAnchorNone: 1,
         msoAnchorCenter: 2
     }

     var MsoVerticalAnchor = {
     ...
     var MsoFarEastLineBreakLanguageID = {
     ...
     var MsoFeatureInstall = {
         msoFeatureInstallNone: 0,
         msoFeatureInstallOnDemand: 1,
         msoFeatureInstallOnDemandWithUI: 2
     }

     var MsoScriptLanguage = {
     ...
     var ContentVerificationResults = {
         contverresError: 0,
     ...
     var CertificateVerificationResults = {
         certverresError: 0,
     ...
     var MsoCustomXMLValidationErrorType = {
     ...
     var MsoFontLanguageIndex = {
         msoThemeLatin: 1,
         msoThemeComplexScript: 2,
         msoThemeEastAsian: 3
     }

     var MsoShapeStyleIndex = {
     ...
     var MsoCTPDockPositionRestrict = {
     ...
     var MsoNumberedBulletStyle = {
         ...
         msoBulletCirclvarDBPlain: 18,
         msoBulletCirclvarWDWhitePlain: 19,
         msoBulletCirclvarWDBlackPlain: 20,
     ...
     var EncryptionCipherMode = {
         cipherModeECB: 0,
         cipherModeCBC: 1
     }

     var MsoClipboardFormat = {
     ...
     var MsoSmartArtNodeType = {
         msoSmartArtNodeault: 1,
