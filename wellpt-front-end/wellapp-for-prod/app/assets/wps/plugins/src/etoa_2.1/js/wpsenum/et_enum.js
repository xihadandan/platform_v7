     ...
     var XlInsertShiftDirection = {
        xlShiftDown : -4121,
        xlShiftToRight : -4161
    }

     var XlDeleteShiftDirection = {
        xlShiftToLeft : -4159,
        xlShiftUp : -4162
    }
     ...
     var XlApplyNamesOrder = {
        xlColumnThenRow : 2,
        xlRowThenColumn : 1
    }

     var XlEnableCancelKey = {
        xlDisabled : 0,
        xlErrorHandler : 2,
        xlInterrupt : 1
    }
     ...
     var XlApplicationInternational = {
        xl24HourClock : 33,
        xl4DigitYears : 43,
     ...
     var XlPageBreakExtent = {
        xlPageBreakFull : 1,
        xlPageBreakPartial : 2
    }

     var XlCellInsertionMode = {
        xlOverwriteCells : 0,
     ...
     var XlHighlightChangesTime = {
        xlSinceMyLastSave : 1,
        xlAllChanges : 2,
        xlNotYetReviewed : 3
    }

     var XlCommentDisplayMode = {
        xlNoIndicator : 0,
        xlCommentIndicatorOnly : -1,
        xlCommentAndIndicator : 1
    }

     var XlFormatConditionType = {
        xlCellValue : 1,
        xlExpression : 2,
        xlColorScale : 3,
        xlDatabar : 4,
     ...
     var XlLayoutFormType = {
        xlTabular : 0,
        xlOutline : 1
    }

     var XlRoutingSlipDelivery = {
        xlAllAtOnce : 2,
        xlOneAfterAnother : 1
    }

     var XlRoutingSlipStatus = {
        xlNotYetRouted : 0,
        xlRoutingComplete : 2,
     ...
     var XlSaveAction = {
        xlDoNotSaveChanges : 0,
        xlSaveChanges : 1
    }

     var XlSaveAsAccessMode = {
        xlExclusive : 3,
        xlNoChange : 1,
        xlShared : 2
    }

     var XlSaveConflictResolution = {
        xlLocalSessionChanges : 2,
        xlOtherSessionChanges : 3,
        xlUserResolution : 1
    }

     var XlSearchDirection = {
        xlNext : 1,
        xlPrevious : 2
    }
     ...
     var XlDisplayDrawingObjects = {
        xlDisplayShapes : -4104,
        xlHide : 3,
        xlPlaceholders : 2
    }

     var XlSubtototalLocationType = {
        xlAtTop : 1,
        xlAtBottom : 2
    }

     var XlPivotTableVersionList = {
     ...
     var XlCalculationState = {
        xlDone : 0,
        xlCalculating : 1,
        xlPending : 2
    }

     var XlCalculationInterruptKey = {
        xlNoKey : 0,
        xlEscKey : 1,
        xlAnyKey : 2
    }

     var XlSortDataOption = {
        xlSortNormal : 0,
     ...
     var XlSmartTagDisplayMode = {
        xlIndicatorAndButton : 0,
        xlDisplayNone : 1,
        xlButtonOnly : 2
    }

     var XlRangeValueDataType = {
        xlRangeValueDefault : 10,
        xlRangeValueXMLSpreadsheet : 11,
        xlRangeValueMSPersistXML : 12
    }

     var XlSpeakDirection = {
        xlSpeakByRows : 0,
        xlSpeakByColumns : 1
    }

     var XlInsertFormatOrigin = {
     ...
     var XlConditionValueTypes = {
        xlConditionValueNone : -1,
        xlConditionValuvarber : 0,
     ...
     var XlMeasurementUnits = {
        xlInches : 0,
        xlCentimeters : 1,
        xlMillimeters : 2
    }

     var XlPivotFilterType = {
        xlTopCount : 1,
        xlBottomCount : 2,
        xlTopPercent : 3,
        xlBottomPercent : 4,
     ...
     var XlAllocationValue = {
        xlAllocateValue : 1,
        xlAllocateIncrement : 2
    }

     var XlAllocationMethod = {
        xlEqualAllocation : 1,
        xlWeightedAllocation : 2
    }

     var XlCellChangedState = {
        xlCellNotChanged : 1,
        xlCellChanged : 2,
        xlCellChangeApplied : 3
    }

     var XlPivotFieldRepeatLabels = {
     ...
     var XlCalcMemNumberFormatType = {
        xlNumberFormatault : 0,
        xlNumberFormatTypvarber : 1,
