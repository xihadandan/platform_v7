...
var OFD = (function (_w) {
  ...
  var Tool = {
    ...
    isPlainObject: function (v) {
      ...
      try {
        if (v.constructor && !v.hasOwnProperty('constructor') && !v.constructor.prototype.hasOwnProperty('isPrototypeOf')) {
          return false;
        }
      } catch (e) {
        return false;
    ...
    each: function (o, fn) {
      ...
      if (this.isArray(o)) {
        for (var i = 0, ol = o.length, val = o[0]; i < ol && fn.call(val, i, val) !== false; val = o[++i]) {}
      } else {
        for (var i in o) {
