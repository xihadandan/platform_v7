define(['jquery', 'server', 'commons', 'constant', 'appContext', 'appModal', 'DmsFileManagerDyformDocumentView'], function (
  $,
  server,
  commons,
  constant,
  appContext,
  appModal,
  DmsFileManagerDyformDocumentView
) {
        ...
        JDS.call({
          ...
          success: function (result) {
            ...
            if (data) {
              ...
              var newDataUuid = data[dyformOptions.formData.formUuid][0].uuid;
              dyformOptions.formData.addedFormDatas[dyformOptions.formData.formUuid][0] = newDataUuid;
            }
          }
        });
      }
