...
(function (root, factory) {
  ...
  var coreLikelySubtags = function (Cldr, cldr, subtags, options) {
    ...
    matchFound = arraySome(
      [[language, script, territory], [language, territory], [language, script], [language], ['und', script]],
      function (test) {
  ...
  Cldr.prototype.init = function (locale) {
    ...
    // Unicode locale extensions.
    unicodeLocaleExtensions &&
      ('-' + unicodeLocaleExtensions).replace(/-[a-z]{3,8}|(-[a-z]{2})-([a-z]{3,8})/g, function (attribute, key, type) {
        if (key) {
