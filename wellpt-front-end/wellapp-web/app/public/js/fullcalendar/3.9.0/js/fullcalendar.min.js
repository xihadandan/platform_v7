...
----------------------------------------------------------------------------------------------------------------------*/
      ...
      function matchCellWidths(els) {
        ...
        els.find('> *').each(function (i, innerEl) {
          //bug#62815 日程管理-日程管理和我的关注列表来回切换，会出现日历面板时间显示异常
          var innerWidth = 50 || $(innerEl).outerWidth();
...
*/
    ...
    ------------------------------------------------------------------------------------------------------------------*/
        ...
        DayTableMixin.prototype.renderBgCellHtml = function (date, otherAttrs) {
          ...
          var blankTitle = this.opt("configuration") && this.opt("configuration").titleJson && this.opt("configuration").titleJson.blankTitle;
    ...
    ------------------------------------------------------------------------------------------------------------------*/
        ...
        DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
          ...
          var content = $('<div class="fc-header ' + theme.getClass('popoverHeader') + '">' +
            ...
            '<div class="fc-event-container scrollbar"></div>' +
            '</div>');
...
*/
      var TimeGridEventRenderer = /** @class */ (function (_super) {
        ...
        TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
          ...
          if (view.isMultiDayRange(componentFootprint.unzonedRange)) {
            ...
            timeText = this.getTimeText(seg.footprint, seg.footprint.eventDef.miscProps.formatStr || null);
            fullTimeText = this.getTimeText(seg.footprint, 'LT');
            startTimeText = this.getTimeText(seg.footprint, null, false); // displayEnd=false
          }
          var a_title = this.opt("configuration") && this.opt("configuration").titleJson && this.opt("configuration").titleJson.eventTitle; //鼠标显示 文字
          var e_title = eventDef.miscProps && eventDef.miscProps.customTitle ? eventDef.miscProps.customTitle : eventDef.title; //日历视图 事项标题
          var fc_content_title = (timeText ? timeText + ' ' : "") + e_title;
      ...
      function isSlotSegCollision(seg1, seg2) {
        if (seg1.bottom - seg1.top < 32) {
          seg1.bottom = seg1.top + 31
        }
        if (seg2.bottom - seg2.top < 32) {
          seg2.bottom = seg2.top + 31
        }
...
----------------------------------------------------------------------------------------------------------------------*/
      var DayGridEventRenderer = /** @class */ (function (_super) {
        ...
        DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
          ...
          var skinCss = util_1.cssToStr(this.getSkinCss(eventDef));
          var timeHtml = '';
          var timeText, _timeText;
          var titleHtml;
          var a_title = this.opt("configuration") && this.opt("configuration").titleJson && this.opt("configuration").titleJson.eventTitle;
          classes.unshift('fc-day-grid-event', 'fc-h-event');
          // Only display a timed events time if it is the starting segment
          if (seg.isStart) {
            timeText = this.getTimeText(seg.footprint, seg.footprint.eventDef.miscProps.formatStr || null);
            // _timeText = seg.footprint.eventInstance.dateProfile.start.format("YYYY-MM-DD HH:mm")+'-'+seg.footprint.eventInstance.dateProfile.end.format("YYYY-MM-DD HH:mm")
            if (timeText) {
              timeHtml = '<span class="fc-time">' + util_1.htmlEscape(timeText) + '</span>';
            }
            // if (!a_title && timeText) {
            //   a_title = timeText + ' ' + util_1.htmlEscape(eventDef.title || '');
            // }
          }
          var e_title = eventDef.miscProps && eventDef.miscProps.customTitle ? eventDef.miscProps.customTitle : eventDef.title;
          titleHtml =
            '<span class="fc-title" >' +
            (util_1.htmlEscape(e_title || '') || '&nbsp;') + // we always want one line of height
            '</span>';
          // 时间与标题显示的前后顺序
          var fc_content_title = "";
          if (timeText) {
            if (this.dayGrid.isRTL) {
              fc_content_title = e_title + ' ' + timeText;
            } else {
              fc_content_title = timeText + ' ' + e_title;
            }
          } else {
            fc_content_title = e_title;
          }
          return '<a class="' + classes.join(' ') + '"' +
            (eventDef.url ?
              ' href="' + util_1.htmlEscape(eventDef.url) + '"' :
    ...
    (function (module, exports, __webpack_require__) {
      ...
      Bootstrap3Theme.prototype.classes = {
        ...
        button: 'btn well-btn w-btn-primary w-line-btn',
        stateActive: 'active',
      ...
      Bootstrap3Theme.prototype.iconOverridePrefix = '';
