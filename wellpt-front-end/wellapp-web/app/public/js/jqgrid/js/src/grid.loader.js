...
{
    var pathtojsfiles = "/wellpt/resources/jqgrid/js/src/"; // need to be ajusted
    ...
    var modules = [
        ...
        { include: true, incfile:'jqDnR.js'}, // search Plugin
        { include: true, incfile:'jqModal.js'} // search Plugin
    ];
    var filename;
