...
$(function() {
	...
	jQuery.validator.addMethod("isCustomizeRegularText", function(value, element,param) {
		return this.optional(element) || value.match(new RegExp(param, "i"));
	}, "值不符合条件");
	jQuery.validator.addMethod("validateEvent", function(value, element,script) {
		var result;
	...
	// 判断浮点型
	jQuery.validator.addMethod("isFloat", function(value, element, nd) {
        var rtn = this.optional(element) || /^[-\+]?\d+(\.\d+)?$/.test(value);
    ...
    // 判断正浮点型
    jQuery.validator.addMethod("isPositiveFloat", function(value, element, nd) {
        var rtn = this.optional(element) || /^[+]?\d+(\.\d+)?$/.test(value);
        if(rtn && nd && nd.decimal > 0 ){
            value = "" + value;
            var scaleIdx = value.indexOf(".");
	...
	jQuery.validator.addMethod("isInteger", function(value, element) {
		return this.optional(element) || (/^[-\+]?[Ee\d]+$/.test(value));
	}, "匹配integer");

	// 匹配负integer
	jQuery.validator.addMethod("isNegative", function(value, element) {
		console.log(value);
		return this.optional(element) || (/^[-\+]?[Ee\d]+$/.test(value) && parseInt(value) < 0);
	}, "匹配integer");
	...
	// 判断数值类型，包括整数和浮点数
	jQuery.validator.addMethod("isNumber", function(value, element, nd) {
		var didx, rtn = this.optional(element) || /^[-\+]?[Ee\d]+$/.test(value) || /^[-\+]?\d+(\.\d+)?$/.test(value);
