...
(function (root, factory) {
  ...
  var numberParseProperties = function (pattern, cldr, options) {
    ...
    if (!isNaN(minimumSignificantDigits * maximumSignificantDigits) /* 1 */ || maximumFractionDigits /* 2 */) {
   ...
   */
  var numberFormatIntegerFractionDigits = function (
    number,
    minimumIntegerDigits,
    minimumFractionDigits,
    maximumFractionDigits,
  ...
  var numberFormat = function (number, properties, pluralGenerator) {
    ...
    // Infinity
    if (!isFinite(number)) {
      return prefix.concat({ type: 'infinity', value: infinitySymbol }, suffix);
    }
    ...
    if (!isNaN(minimumSignificantDigits * maximumSignificantDigits)) {
      ...
      number = numberFormatIntegerFractionDigits(
        number,
        minimumIntegerDigits,
        minimumFractionDigits,
        maximumFractionDigits,
