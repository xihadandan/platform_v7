...
function WeixinQRStrategy(options, verify) {
    if (typeof options == 'function') {
        verify = options;
        options = {};
    }
    if (!verify) { throw new TypeError('WeixinQRStrategy requires a verify callback'); }
...
WeixinQRStrategy.prototype.authenticate = function (req, options) {
    options = options || {};
...
util.inherits(WeixinQRStrategy, Strategy);


module.exports = WeixinQRStrategy;