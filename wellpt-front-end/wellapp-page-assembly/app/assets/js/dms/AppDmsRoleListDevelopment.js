define(["constant", "commons", "server", "ListViewWidgetDevelopment"],
    function(constant, commons, server, ListViewWidgetDevelopment) {
        // 视图组件二开基础
        var AppDmsRoleListWidgetDevelopment = function() {
            ListViewWidgetDevelopment.apply(this, arguments);
        };
        // 接口方法
        commons.inherit(AppDmsRoleListWidgetDevelopment, ListViewWidgetDevelopment, {
        ...
        return AppDmsRoleListWidgetDevelopment;
    });