require([ "jquery", "jquery-ui", "bootstrap", "ckeditor" ], function($) {
			var webpage = "";
			...
			function saveLayout() {
				...
				// console.log(data);
				/*
				 * $.ajax({ type: "POST", url: "/build/saveLayout", data: {
				 * layout: $('.demo').html() }, success: function(data) {
			...
			function initGridPicker(){
			    ...
			    grid += '</div>';
			    var $gridChooser = $('#grid-shortcut');
			    var $grid = $(grid).height(rows * 24).width(cols * 24).insertAfter($gridChooser);
			    $grid.find('.row').css({
			...
			function saveHtml() {
				webpage = '<html>\n<head>\n<script type="text/javascript" src="http://www.francescomalagrino.com/BootstrapPageGenerator/3/js/jquery-2.0.0.min.js"></script>\n<script type="text/javascript" src="http://www.francescomalagrino.com/BootstrapPageGenerator/3/js/jquery-ui"></script>\n<link href="http://www.francescomalagrino.com/BootstrapPageGenerator/3/css/bootstrap-combined.min.css" rel="stylesheet" media="screen">\n<script type="text/javascript" src="http://www.francescomalagrino.com/BootstrapPageGenerator/3/js/bootstrap.min.js"></script>\n</head>\n<body>\n'
						+ webpage + '\n</body>\n</html>'
				/*
				 * FM aka Vegetam Added the function that save the file in the
				 * directory Downloads. Work only to Chrome Firefox And IE
				 */
