<template>
  <div style="position: absolute; left: 0px; right: 0px; width: 100%; height: 100%" class="login-right">
    <a-carousel
      effect="fade"
      :autoplay="true"
      :dots="false"
    ...
    <div :style="vStyle" class="login-basic-center">
      <div class="login-win" :style="loginWinStyle" @click.stop="() => {}">
        ...
        <a-tabs v-model="loginFormKey" default-active-key="accountLogin" size="small">
            ...
            <div class="rowInput">
              <div class="row">
                <a-input
                  ...
                  size="large"
                  autocomplete="off"
                  :placeholder="$t('loginComponent.acctInputPlaceholder', '请输入用户名')"
                >
