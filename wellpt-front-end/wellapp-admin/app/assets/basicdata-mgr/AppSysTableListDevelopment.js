define(["constant", "commons", "server", "ListViewWidgetDevelopment"],
    function(constant, commons, server, ListViewWidgetDevelopment) {
        // 视图组件二开基础
        var AppSysTableListDevelopment = function() {
            ListViewWidgetDevelopment.apply(this, arguments);
        };
        // 接口方法
        commons.inherit(AppSysTableListDevelopment, ListViewWidgetDevelopment, {

            btn_import: function() { // 导入
                this.onImport()
            },

            btn_export: function() { // 导出
                this.onExport("systemTable")
            },
        ...
        return AppSysTableListDevelopment;
    });