...
class Genid {
   ...
   *     BaseTime: 949334400000,  // 基础时间（ms 单位），不能超过当前系统时间
  ...
  constructor(options) {
    ...
    // 1.BaseTime
    const BaseTime = 1672502400000; // 2023.1.1 0:0:0.000
  ...
  CalcId(useTimeTick) {
    const result =
      BigInt(useTimeTick << this._TimestampShift) + BigInt(this.WorkerId << this.SeqBitLength) + BigInt(this._CurrentSeqNumber);
