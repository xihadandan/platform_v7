<template>
  <view class="w-dyform-container">
    <uni-nav-bar v-if="chooseDyformToPreview">
      <template slot="default">
        <view
          @click="onClickChangeForm"
          style="display: flex; width: 100%; align-items: center; justify-content: center"
        >
          <text style="font-weight: bolder">选择表单</text>
    ...
    <uni-popup ref="selectFormPopup" background-color="#fff" type="bottom">
      <view>
        <uni-search-bar :focus="true" v-model="formKeyword" @input="getFormDefinition"> </uni-search-bar>
        <view>
