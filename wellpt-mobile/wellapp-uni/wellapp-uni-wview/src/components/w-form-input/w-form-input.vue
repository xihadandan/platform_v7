    ...
    <template v-if="!displayAsLabel">
      <view v-if="widget.configuration.type == 'textarea'" :class="['input-textarea']">
        <uni-w-easyinput
          ...
          :autoHeight="widget.configuration.uniConfiguration.autoHeight"
          :clearable="widget.configuration.clearBtnShow"
        ...
        <template v-if="disable || readonly">
          ...
          >
            <template v-if="hasAddonSetting">
              ...
              <text class="addon-before" slot="addonBefore" v-if="hasAddonBefore">
                <span class="text">{{ addonBeforeValue }}</span>
              </text>
              <text class="addon-after" slot="addonAfter" v-if="hasAddonAfter">
