<template>
  <view class="uni-w-line-progress">
    <view
      class="u-progress"
      :style="{
        height: height + 'px',
    ...
    >
      <view
        ...
        class="u-active"
        :style="[progressStyle, { borderRadius: round ? '100rpx' : 0 }]"
      >
      </view>
    </view>
    <view :style="textStyle" class="u-progress-text" v-if="showPercent">
