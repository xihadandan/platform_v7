    ...
    >
      <view class="uni-calendar__header" :class="{ 'uni-calendar__header-mobile': !insert }">
        <view class="uni-calendar__header-btn-box" @click.stop="changeMonth('pre')">
          <w-icon icon="iconfont icon-ptkj-xianmiaojiantou-zuo" :size="14"></w-icon>
          <!-- <view class="uni-calendar__header-btn uni-calendar--left"></view> -->
        </view>
        <uni-w-picker
          mode="time"
          v-model="pickerMonthShow"
          :default-time="date"
          :title="$t('uni-datetime-picker.selectMonth')"
          :params="pickerParams"
          closeIcon
          @confirm="bindDateChange"
        >
          <text class="uni-calendar__header-text">{{ nowDateText }}</text>
        </uni-w-picker>
        ...
        <view class="uni-calendar__header-btn-box" @click.stop="changeMonth('next')">
          <w-icon icon="iconfont icon-ptkj-xianmiaojiantou-you" :size="14"></w-icon>
          <!-- <view class="uni-calendar__header-btn uni-calendar--right"></view> -->
        </view>

        <view v-if="!insert" class="dialog-close" @click="maskClick">
          <w-icon icon="iconfont icon-ptkj-dacha-xiao" :size="16"></w-icon>
  ...
  computed: {
    ...
    nowDateText() {
      if (this.$i18n.locale.startsWith("en")) {
        ...
        return monthsShort[Number(this.nowDate.month) - 1] + " " + this.nowDate.year;
      }
...
$uni-calendar-border-radius: 16px 16px 0 0;
...
.uni-calendar__content-mobile {
  border-radius: $uni-calendar-border-radius;
...
.uni-calendar--fixed-top {
  ...
  border-top-color: var(--w-border-color-mobile);
...
.dialog-close-plus {
  width: 16px;
  height: 2px;
  background-color: var(--w-text-color-mobile);
  border-radius: 2px;
  transform: rotate(45deg);
}
