...
export default {
  ...
  methods: {
    ...
    goto() {
      uni.navigateTo({
        url: "/packages/_/pages/pwd/update-password",
      });
    },
    goToThemeSettings() {
      uni.navigateTo({
        url: "/packages/_/pages/theme/settings",
      });
    },
    goToWorkbenchSettings() {
      uni.navigateTo({
        url: "/packages/_/pages/user/workbench_settings",
      });
    },
    gotoAbout() {
      uni.navigateTo({
        url: "/packages/_/pages/about/about",
      });
    },
  },
};
