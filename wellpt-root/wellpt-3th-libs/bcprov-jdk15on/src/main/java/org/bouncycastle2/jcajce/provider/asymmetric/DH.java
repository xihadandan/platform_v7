...
import org.bouncycastle2.jcajce.provider.asymmetric.dh.KeyFactorySpi;
...
public class DH
{
    private static final String PREFIX = "org.bouncycastle2.jcajce.provider.asymmetric" + ".dh.";
