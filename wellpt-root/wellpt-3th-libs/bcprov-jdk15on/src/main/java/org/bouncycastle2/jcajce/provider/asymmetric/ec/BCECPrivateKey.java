...
import org.bouncycastle2.jcajce.provider.asymmetric.util.PKCS12BagAttributeCarrierImpl;
    ...
    implements ECPrivateKey, org.bouncycastle2.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
        ...
        throws IOException
    {
        ...
        {
            org.bouncycastle2.asn1.sec.ECPrivateKey ec = org.bouncycastle2.asn1.sec.ECPrivateKey.getInstance(privKey);
    ...
    public byte[] getEncoded()
    {
        ...
        PrivateKeyInfo          info;
        org.bouncycastle2.asn1.sec.ECPrivateKey            keyStructure;

        if (publicKey != null)
        {
            keyStructure = new org.bouncycastle2.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), publicKey, params);
        }
        else
        {
            keyStructure = new org.bouncycastle2.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), params);
        }
    ...
    private org.bouncycastle2.math.ec.ECPoint calculateQ(org.bouncycastle2.jce.spec.ECParameterSpec spec)
    {
