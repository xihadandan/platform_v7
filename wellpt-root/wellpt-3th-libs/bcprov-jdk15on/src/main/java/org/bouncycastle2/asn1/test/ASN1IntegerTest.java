    ...
    extends SimpleTest
{
    ...
    public void performTest()
        throws Exception
    {
        System.setProperty("org.bouncycastle2.asn1.allow_unsafe_integer", "true");
        ...
        System.setProperty("org.bouncycastle2.asn1.allow_unsafe_integer", "false");
        ...
        isTrue(!Properties.setThreadOverride("org.bouncycastle2.asn1.allow_unsafe_integer", true));
        
        new ASN1Integer(Hex.decode("ffda47bfc776bcd269da4832626ac332adfca6dd835e8ecd83cd1ebe7d709b"));

        isTrue(Properties.removeThreadOverride("org.bouncycastle2.asn1.allow_unsafe_integer"));
        ...
        throws Exception
    {
        ...
        try
        {
            System.getProperties().put("org.bouncycastle2.asn1.allow_unsafe_integer", "true");
            byte[] rawInt = Hex.decode("0000000010FF");
            ASN1Integer i = new ASN1Integer(rawInt);
            fail("Expecting illegal argument exception.");
        }
