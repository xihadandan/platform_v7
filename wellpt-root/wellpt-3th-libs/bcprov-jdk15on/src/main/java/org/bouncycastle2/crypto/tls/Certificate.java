 ...
 * </pre>
 *
 * @see org.bouncycastle2.asn1.x509.Certificate
 */
public class Certificate
{
    public static final Certificate EMPTY_CHAIN = new Certificate(
        new org.bouncycastle2.asn1.x509.Certificate[0]);

    protected org.bouncycastle2.asn1.x509.Certificate[] certificateList;

    public Certificate(org.bouncycastle2.asn1.x509.Certificate[] certificateList)
    {
     ...
     *         chain.
     */
    public org.bouncycastle2.asn1.x509.Certificate[] getCertificateList()
    {
        return cloneCertificateList();
    }

    public org.bouncycastle2.asn1.x509.Certificate getCertificateAt(int index)
    {
        ...
        throws IOException
    {
        ...
        while (buf.available() > 0)
        {
            ...
            certificate_list.addElement(org.bouncycastle2.asn1.x509.Certificate.getInstance(asn1Cert));
        }

        org.bouncycastle2.asn1.x509.Certificate[] certificateList = new org.bouncycastle2.asn1.x509.Certificate[certificate_list.size()];
        for (int i = 0; i < certificate_list.size(); i++)
        {
            certificateList[i] = (org.bouncycastle2.asn1.x509.Certificate)certificate_list.elementAt(i);
        }
        return new Certificate(certificateList);
    }

    protected org.bouncycastle2.asn1.x509.Certificate[] cloneCertificateList()
    {
        org.bouncycastle2.asn1.x509.Certificate[] result = new org.bouncycastle2.asn1.x509.Certificate[certificateList.length];
