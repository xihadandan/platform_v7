package org.bouncycastle2.jcajce.provider.asymmetric.dstu;
...
import org.bouncycastle2.asn1.ua.DSTU4145BinaryField;
import org.bouncycastle2.asn1.ua.DSTU4145ECBinary;
import org.bouncycastle2.asn1.ua.DSTU4145NamedCurves;
import org.bouncycastle2.asn1.ua.DSTU4145Params;
import org.bouncycastle2.asn1.ua.DSTU4145PointEncoder;
import org.bouncycastle2.asn1.ua.UAObjectIdentifiers;
...
import org.bouncycastle2.jcajce.provider.asymmetric.util.ECUtil;
import org.bouncycastle2.jcajce.provider.asymmetric.util.KeyUtil;
    ...
    implements ECPublicKey, org.bouncycastle2.jce.interfaces.ECPublicKey, ECPointEncoder
{
        ...
        ProviderConfiguration configuration)
    {
        ...
        {
            org.bouncycastle2.jce.spec.ECParameterSpec s = configuration.getEcImplicitlyCa();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        org.bouncycastle2.jce.spec.ECParameterSpec spec = null;
        ...
        else
        {
            ...
            spec = new org.bouncycastle2.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
        }
    ...
    {
        org.bouncycastle2.math.ec.ECPoint q = ecPublicKey.getQ();
