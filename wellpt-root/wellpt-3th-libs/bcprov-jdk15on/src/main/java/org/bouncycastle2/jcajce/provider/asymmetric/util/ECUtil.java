...
import org.bouncycastle2.asn1.anssi.ANSSINamedCurves;
import org.bouncycastle2.asn1.cryptopro.ECGOST3410NamedCurves;
import org.bouncycastle2.asn1.gm.GMNamedCurves;
...
import org.bouncycastle2.asn1.x9.ECNamedCurveTable;
...
import org.bouncycastle2.crypto.ec.CustomNamedCurves;
...
import org.bouncycastle2.jcajce.provider.config.ProviderConfiguration;
...
import org.bouncycastle2.util.Fingerprint;
...
public class ECUtil
{
    ...
    public static ECDomainParameters getDomainParameters(
        ...
        org.bouncycastle2.jce.spec.ECParameterSpec params)
    {
        ...
        {
            org.bouncycastle2.jce.spec.ECParameterSpec iSpec = configuration.getEcImplicitlyCa();
        ...
        ECParameterSpec ecParameterSpec)
    {
        for (Enumeration names = ECNamedCurveTable.getNames(); names.hasMoreElements();)
        {
            ...
            {
                return org.bouncycastle2.asn1.x9.ECNamedCurveTable.getOID(name);
            }
        }
    ...
    public static String privateKeyToString(String algorithm, BigInteger d, org.bouncycastle2.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();

        org.bouncycastle2.math.ec.ECPoint q = calculateQ(d, spec);
    ...
    private static org.bouncycastle2.math.ec.ECPoint calculateQ(BigInteger d, org.bouncycastle2.jce.spec.ECParameterSpec spec)
    {
        return spec.getG().multiply(d).normalize();
    }

    public static String publicKeyToString(String algorithm, org.bouncycastle2.math.ec.ECPoint q, org.bouncycastle2.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();
    ...
    public static String generateKeyFingerprint(ECPoint publicPoint, org.bouncycastle2.jce.spec.ECParameterSpec spec)
    {
