...
import org.bouncycastle2.jcajce.provider.util.DigestFactory;
    ...
    extends SignatureSpi
{
    ...
    private org.bouncycastle2.crypto.signers.PSSSigner pss;
        ...
        int trailerField)
    {
        if (trailerField == 1)
        {
            return org.bouncycastle2.crypto.signers.PSSSigner.TRAILER_IMPLICIT;
        }
        ...
        throws InvalidKeyException
    {
        ...
        pss = new org.bouncycastle2.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest, saltLength, trailer);
        pss.init(false,
