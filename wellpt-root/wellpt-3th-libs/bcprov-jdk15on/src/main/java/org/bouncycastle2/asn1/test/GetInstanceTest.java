...
import org.bouncycastle2.asn1.ASN1Enumerated;
import org.bouncycastle2.asn1.ASN1GeneralizedTime;
import org.bouncycastle2.asn1.ASN1Integer;
import org.bouncycastle2.asn1.ASN1Object;
import org.bouncycastle2.asn1.ASN1ObjectIdentifier;
import org.bouncycastle2.asn1.ASN1TaggedObject;
import org.bouncycastle2.asn1.ASN1UTCTime;
import org.bouncycastle2.asn1.DERBMPString;
import org.bouncycastle2.asn1.DERBitString;
import org.bouncycastle2.asn1.DERGeneralString;
import org.bouncycastle2.asn1.DERIA5String;
import org.bouncycastle2.asn1.DERNull;
import org.bouncycastle2.asn1.DERNumericString;
...
import org.bouncycastle2.asn1.cmp.CAKeyUpdAnnContent;
import org.bouncycastle2.asn1.cmp.CMPCertificate;
import org.bouncycastle2.asn1.cmp.CRLAnnContent;
import org.bouncycastle2.asn1.cmp.CertConfirmContent;
import org.bouncycastle2.asn1.cmp.CertOrEncCert;
import org.bouncycastle2.asn1.cmp.CertRepMessage;
import org.bouncycastle2.asn1.cmp.CertResponse;
import org.bouncycastle2.asn1.cmp.CertifiedKeyPair;
import org.bouncycastle2.asn1.cmp.Challenge;
import org.bouncycastle2.asn1.cmp.ErrorMsgContent;
import org.bouncycastle2.asn1.cmp.GenMsgContent;
import org.bouncycastle2.asn1.cmp.GenRepContent;
import org.bouncycastle2.asn1.cmp.InfoTypeAndValue;
import org.bouncycastle2.asn1.cmp.KeyRecRepContent;
import org.bouncycastle2.asn1.cmp.OOBCertHash;
import org.bouncycastle2.asn1.cmp.PBMParameter;
import org.bouncycastle2.asn1.cmp.PKIBody;
import org.bouncycastle2.asn1.cmp.PKIConfirmContent;
...
import org.bouncycastle2.asn1.cmp.PKIMessages;
import org.bouncycastle2.asn1.cmp.PKIStatus;
import org.bouncycastle2.asn1.cmp.PKIStatusInfo;
import org.bouncycastle2.asn1.cmp.POPODecKeyChallContent;
import org.bouncycastle2.asn1.cmp.POPODecKeyRespContent;
import org.bouncycastle2.asn1.cmp.PollRepContent;
import org.bouncycastle2.asn1.cmp.PollReqContent;
import org.bouncycastle2.asn1.cmp.ProtectedPart;
import org.bouncycastle2.asn1.cmp.RevAnnContent;
import org.bouncycastle2.asn1.cmp.RevDetails;
import org.bouncycastle2.asn1.cmp.RevRepContent;
import org.bouncycastle2.asn1.cmp.RevReqContent;
...
import org.bouncycastle2.asn1.cms.EncryptedData;
...
import org.bouncycastle2.asn1.cms.OtherKeyAttribute;
import org.bouncycastle2.asn1.cms.OtherRecipientInfo;
...
import org.bouncycastle2.asn1.crmf.OptionalValidity;
...
import org.bouncycastle2.asn1.crmf.SinglePubInfo;
import org.bouncycastle2.asn1.cryptopro.ECGOST3410ParamSetParameters;
import org.bouncycastle2.asn1.cryptopro.GOST28147Parameters;
...
import org.bouncycastle2.asn1.eac.CVCertificate;
import org.bouncycastle2.asn1.eac.CVCertificateRequest;
import org.bouncycastle2.asn1.eac.CertificateBody;
import org.bouncycastle2.asn1.eac.PublicKeyDataObject;
import org.bouncycastle2.asn1.eac.RSAPublicKey;
import org.bouncycastle2.asn1.eac.UnsignedInteger;
import org.bouncycastle2.asn1.esf.CommitmentTypeIndication;
import org.bouncycastle2.asn1.esf.CommitmentTypeQualifier;
import org.bouncycastle2.asn1.esf.CompleteRevocationRefs;
import org.bouncycastle2.asn1.esf.CrlIdentifier;
import org.bouncycastle2.asn1.esf.CrlListID;
import org.bouncycastle2.asn1.esf.CrlOcspRef;
import org.bouncycastle2.asn1.esf.CrlValidatedID;
import org.bouncycastle2.asn1.esf.OcspIdentifier;
import org.bouncycastle2.asn1.esf.OcspListID;
import org.bouncycastle2.asn1.esf.OcspResponsesID;
import org.bouncycastle2.asn1.esf.OtherHash;
import org.bouncycastle2.asn1.esf.OtherHashAlgAndValue;
import org.bouncycastle2.asn1.esf.OtherRevRefs;
import org.bouncycastle2.asn1.esf.OtherRevVals;
import org.bouncycastle2.asn1.esf.RevocationValues;
import org.bouncycastle2.asn1.esf.SPUserNotice;
import org.bouncycastle2.asn1.esf.SPuri;
import org.bouncycastle2.asn1.esf.SigPolicyQualifierInfo;
import org.bouncycastle2.asn1.esf.SigPolicyQualifiers;
import org.bouncycastle2.asn1.esf.SignaturePolicyId;
import org.bouncycastle2.asn1.esf.SignaturePolicyIdentifier;
import org.bouncycastle2.asn1.esf.SignerAttribute;
import org.bouncycastle2.asn1.esf.SignerLocation;
import org.bouncycastle2.asn1.ess.ContentHints;
import org.bouncycastle2.asn1.ess.ContentIdentifier;
import org.bouncycastle2.asn1.ess.ESSCertID;
import org.bouncycastle2.asn1.ess.ESSCertIDv2;
import org.bouncycastle2.asn1.ess.OtherCertID;
import org.bouncycastle2.asn1.ess.OtherSigningCertificate;
...
import org.bouncycastle2.asn1.icao.DataGroupHash;
import org.bouncycastle2.asn1.icao.LDSSecurityObject;
import org.bouncycastle2.asn1.icao.LDSVersionInfo;
import org.bouncycastle2.asn1.isismtt.ocsp.CertHash;
import org.bouncycastle2.asn1.isismtt.ocsp.RequestedCertificate;
import org.bouncycastle2.asn1.isismtt.x509.AdditionalInformationSyntax;
import org.bouncycastle2.asn1.isismtt.x509.AdmissionSyntax;
import org.bouncycastle2.asn1.isismtt.x509.Admissions;
import org.bouncycastle2.asn1.isismtt.x509.DeclarationOfMajority;
import org.bouncycastle2.asn1.isismtt.x509.MonetaryLimit;
import org.bouncycastle2.asn1.isismtt.x509.NamingAuthority;
import org.bouncycastle2.asn1.isismtt.x509.ProcurationSyntax;
import org.bouncycastle2.asn1.isismtt.x509.ProfessionInfo;
import org.bouncycastle2.asn1.isismtt.x509.Restriction;
...
import org.bouncycastle2.asn1.ocsp.CrlID;
...
import org.bouncycastle2.asn1.smime.SMIMECapabilities;
...
import org.bouncycastle2.asn1.x509.Certificate;
import org.bouncycastle2.asn1.x509.CertificateList;
import org.bouncycastle2.asn1.x509.CertificatePair;
import org.bouncycastle2.asn1.x509.CertificatePolicies;
...
import org.bouncycastle2.asn1.x509.Extensions;
...
import org.bouncycastle2.asn1.x509.PolicyQualifierInfo;
import org.bouncycastle2.asn1.x509.PrivateKeyUsagePeriod;
import org.bouncycastle2.asn1.x509.RoleSyntax;
import org.bouncycastle2.asn1.x509.SubjectDirectoryAttributes;
import org.bouncycastle2.asn1.x509.SubjectKeyIdentifier;
import org.bouncycastle2.asn1.x509.SubjectPublicKeyInfo;
import org.bouncycastle2.asn1.x509.TBSCertList;
import org.bouncycastle2.asn1.x509.TBSCertificate;
...
import org.bouncycastle2.asn1.x509.qualified.SemanticsInformation;
import org.bouncycastle2.asn1.x509.qualified.TypeOfBiometricData;
import org.bouncycastle2.asn1.x509.sigi.NameOrPseudonym;
import org.bouncycastle2.asn1.x509.sigi.PersonalData;
...
import org.bouncycastle2.util.Integers;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        doFullGetInstanceTest(org.bouncycastle2.asn1.cmp.CertStatus.class, new org.bouncycastle2.asn1.cmp.CertStatus(new byte[10], BigInteger.valueOf(1), new PKIStatusInfo(PKIStatus.granted)));
        ...
        doFullGetInstanceTest(SignerAttribute.class, new SignerAttribute(new org.bouncycastle2.asn1.x509.Attribute[]{new org.bouncycastle2.asn1.x509.Attribute(new ASN1ObjectIdentifier("1.2.1"), new DERSet())}));
        ...
        org.bouncycastle2.asn1.pkcs.RSAPublicKey.getInstance(null);
        RSAPublicKey.getInstance(null);
