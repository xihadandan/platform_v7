package org.bouncycastle2.pqc.jcajce.provider.rainbow;
...
import org.bouncycastle2.pqc.asn1.RainbowPrivateKey;
import org.bouncycastle2.pqc.crypto.rainbow.Layer;
import org.bouncycastle2.pqc.crypto.rainbow.RainbowPrivateKeyParameters;
import org.bouncycastle2.pqc.crypto.rainbow.util.RainbowUtil;
import org.bouncycastle2.pqc.jcajce.spec.RainbowPrivateKeySpec;
    ...
    implements PrivateKey
{
    ...
    public int hashCode()
    {
        ...
        hash = hash * 37 + org.bouncycastle2.util.Arrays.hashCode(A1inv);
        hash = hash * 37 + org.bouncycastle2.util.Arrays.hashCode(b1);
        hash = hash * 37 + org.bouncycastle2.util.Arrays.hashCode(A2inv);
        hash = hash * 37 + org.bouncycastle2.util.Arrays.hashCode(b2);
        hash = hash * 37 + org.bouncycastle2.util.Arrays.hashCode(vi);
