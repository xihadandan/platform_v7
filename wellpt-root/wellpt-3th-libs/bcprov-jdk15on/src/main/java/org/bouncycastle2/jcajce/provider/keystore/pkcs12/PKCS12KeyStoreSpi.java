package org.bouncycastle2.jcajce.provider.keystore.pkcs12;
...
import org.bouncycastle2.asn1.BEROctetString;
...
import org.bouncycastle2.jcajce.PKCS12StoreParameter;
import org.bouncycastle2.jcajce.spec.GOST28147ParameterSpec;
import org.bouncycastle2.jcajce.spec.PBKDF2KeySpec;
...
import org.bouncycastle2.jce.provider.JDKPKCS12StoreParameter;
import org.bouncycastle2.util.Arrays;
import org.bouncycastle2.util.Integers;
import org.bouncycastle2.util.Properties;
...
{
    static final String PKCS12_MAX_IT_COUNT_PROPERTY = "org.bouncycastle2.pkcs12.max_it_count";
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            org.bouncycastle2.asn1.pkcs.EncryptedPrivateKeyInfo eIn = org.bouncycastle2.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            org.bouncycastle2.asn1.pkcs.PrivateKeyInfo kInfo = org.bouncycastle2.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
