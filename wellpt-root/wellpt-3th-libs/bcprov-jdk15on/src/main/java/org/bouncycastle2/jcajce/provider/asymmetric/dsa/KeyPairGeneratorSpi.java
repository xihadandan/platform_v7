...
import org.bouncycastle2.crypto.params.DSAParameterGenerationParameters;
...
import org.bouncycastle2.jcajce.provider.asymmetric.util.PrimeCertaintyCalculator;
                ...
                synchronized (lock)
                {
                    ...
                    else
                    {
                        ...
                        if (strength == 1024)
                        {
                            ...
                            if (Properties.isOverrideSet("org.bouncycastle2.dsa.FIPS186-2for1024bits"))
                            {
