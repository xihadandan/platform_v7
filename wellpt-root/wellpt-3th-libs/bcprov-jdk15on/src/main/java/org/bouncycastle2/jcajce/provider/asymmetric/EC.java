...
import org.bouncycastle2.asn1.bsi.BSIObjectIdentifiers;
...
import org.bouncycastle2.jcajce.provider.asymmetric.ec.KeyFactorySpi;
...
public class EC
{
    private static final String PREFIX = "org.bouncycastle2.jcajce.provider.asymmetric" + ".ec.";
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            if (!Properties.isOverrideSet("org.bouncycastle2.ec.disable_mqv"))
            {
