...
import org.bouncycastle2.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST
{
    private static final String PREFIX = "org.bouncycastle2.jcajce.provider.asymmetric" + ".gost.";
