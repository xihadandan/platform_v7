...
import org.bouncycastle2.jcajce.provider.asymmetric.rsa.KeyFactorySpi;
...
public class RSA
{
    private static final String PREFIX = "org.bouncycastle2.jcajce.provider.asymmetric" + ".rsa.";
