...
import org.bouncycastle2.jcajce.provider.asymmetric.elgamal.KeyFactorySpi;
...
{
    private static final String PREFIX = "org.bouncycastle2.jcajce.provider.asymmetric" + ".elgamal.";
