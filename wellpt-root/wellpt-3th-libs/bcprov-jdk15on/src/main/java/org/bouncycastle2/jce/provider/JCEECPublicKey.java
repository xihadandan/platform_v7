...
import org.bouncycastle2.math.ec.custom.sec.SecP256K1Point;
import org.bouncycastle2.math.ec.custom.sec.SecP256R1Point;
    ...
    implements ECPublicKey, org.bouncycastle2.jce.interfaces.ECPublicKey, ECPointEncoder
{
        ...
        org.bouncycastle2.jce.spec.ECPublicKeySpec     spec)
    {
        ...
        else
        {
            if (q.getCurve() == null)
            {
                org.bouncycastle2.jce.spec.ECParameterSpec s = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
