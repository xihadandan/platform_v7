...
import org.bouncycastle2.jcajce.provider.asymmetric.dstu.KeyFactorySpi;
...
{
    private static final String PREFIX = "org.bouncycastle2.jcajce.provider.asymmetric" + ".dstu.";
