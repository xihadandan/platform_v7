package org.bouncycastle2.jcajce.provider.drbg;
...
import org.bouncycastle2.crypto.prng.EntropySource;
import org.bouncycastle2.crypto.prng.EntropySourceProvider;
import org.bouncycastle2.crypto.prng.SP800SecureRandom;
import org.bouncycastle2.crypto.prng.SP800SecureRandomBuilder;
...
import org.bouncycastle2.util.Pack;
...
public class DRBG
{
    ...
    {
        final String sourceClass = System.getProperty("org.bouncycastle2.drbg.entropysource");
    ...
    {
        if (System.getProperty("org.bouncycastle2.drbg.entropysource") != null)
        {
