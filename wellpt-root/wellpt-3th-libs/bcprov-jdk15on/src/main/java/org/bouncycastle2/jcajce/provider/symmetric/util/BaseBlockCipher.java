...
import org.bouncycastle2.asn1.cms.GCMParameters;
...
import org.bouncycastle2.crypto.OutputLengthException;
import org.bouncycastle2.crypto.engines.DSTU7624Engine;
...
import org.bouncycastle2.crypto.modes.GCFBBlockCipher;
import org.bouncycastle2.crypto.modes.GCMBlockCipher;
import org.bouncycastle2.crypto.modes.GOFBBlockCipher;
import org.bouncycastle2.crypto.modes.KCCMBlockCipher;
import org.bouncycastle2.crypto.modes.KCTRBlockCipher;
import org.bouncycastle2.crypto.modes.KGCMBlockCipher;
import org.bouncycastle2.crypto.modes.OCBBlockCipher;
...
import org.bouncycastle2.jcajce.PBKDF1Key;
import org.bouncycastle2.jcajce.PBKDF1KeyWithParameters;
import org.bouncycastle2.jcajce.PKCS12Key;
import org.bouncycastle2.jcajce.PKCS12KeyWithParameters;
import org.bouncycastle2.jcajce.spec.AEADParameterSpec;
import org.bouncycastle2.jcajce.spec.GOST28147ParameterSpec;
import org.bouncycastle2.jcajce.spec.RepeatedSecretKeySpec;
    ...
    implements PBE
{
    ...
    protected BaseBlockCipher(
        org.bouncycastle2.crypto.BlockCipher engine,
        int ivLength)
    {
        ...
        implements GenericBlockCipher
    {
        ...
        BufferedGenericBlockCipher(org.bouncycastle2.crypto.BlockCipher cipher)
        {
            this.cipher = new PaddedBufferedBlockCipher(cipher);
        }

        BufferedGenericBlockCipher(org.bouncycastle2.crypto.BlockCipher cipher, BlockCipherPadding padding)
        {
