package org.bouncycastle2.jcajce.provider.keystore.bcfks;
...
import org.bouncycastle2.asn1.bc.EncryptedObjectStoreData;
import org.bouncycastle2.asn1.bc.EncryptedPrivateKeyData;
import org.bouncycastle2.asn1.bc.EncryptedSecretKeyData;
import org.bouncycastle2.asn1.bc.ObjectData;
import org.bouncycastle2.asn1.bc.ObjectDataSequence;
import org.bouncycastle2.asn1.bc.ObjectStore;
import org.bouncycastle2.asn1.bc.ObjectStoreData;
import org.bouncycastle2.asn1.bc.ObjectStoreIntegrityCheck;
import org.bouncycastle2.asn1.bc.PbkdMacIntegrityCheck;
import org.bouncycastle2.asn1.bc.SecretKeyData;
import org.bouncycastle2.asn1.cms.CCMParameters;
import org.bouncycastle2.asn1.kisa.KISAObjectIdentifiers;
import org.bouncycastle2.asn1.misc.MiscObjectIdentifiers;
import org.bouncycastle2.asn1.misc.ScryptParams;
import org.bouncycastle2.asn1.nist.NISTObjectIdentifiers;
import org.bouncycastle2.asn1.nsri.NSRIObjectIdentifiers;
...
import org.bouncycastle2.crypto.digests.SHA3Digest;
...
import org.bouncycastle2.crypto.generators.SCrypt;
import org.bouncycastle2.crypto.params.KeyParameter;
import org.bouncycastle2.crypto.util.PBKDF2Config;
import org.bouncycastle2.crypto.util.PBKDFConfig;
import org.bouncycastle2.crypto.util.ScryptConfig;
import org.bouncycastle2.jcajce.BCFKSStoreParameter;
    ...
    extends KeyStoreSpi
{
    ...
    public Certificate[] engineGetCertificateChain(String alias)
    {
        ...
        if (ent != null)
        {
            ...
            {
                EncryptedPrivateKeyData encPrivData = EncryptedPrivateKeyData.getInstance(ent.getData());
                org.bouncycastle2.asn1.x509.Certificate[] certificates = encPrivData.getCertificateChain();
    ...
    private Certificate decodeCertificate(Object cert)
    {
        if (provider != null)
        {
            try
            {
                ...
                return certFact.generateCertificate(new ByteArrayInputStream(org.bouncycastle2.asn1.x509.Certificate.getInstance(cert).getEncoded()));
            }
            catch (Exception e)
            {
                return null;
    ...
    {
        org.bouncycastle2.asn1.x509.Certificate[] certChain = new org.bouncycastle2.asn1.x509.Certificate[chain.length];
        for (int i = 0; i != chain.length; i++)
        {
            certChain[i] = org.bouncycastle2.asn1.x509.Certificate.getInstance(chain[i].getEncoded());
        }
