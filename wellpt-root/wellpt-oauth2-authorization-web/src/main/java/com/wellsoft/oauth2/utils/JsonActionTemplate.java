...
public final class JsonActionTemplate {
     ...
     * @author l.xue.nong
     */
    public static abstract class AbstractResponseMeesageCallback extends AbstractMeesageCallback
            implements MeesageCallback {
     ...
     * @author l.xue.nong
     */
    public static abstract class SingleObjectMeesageCallBack extends AbstractResponseMeesageCallback
            implements MeesageCallback {
