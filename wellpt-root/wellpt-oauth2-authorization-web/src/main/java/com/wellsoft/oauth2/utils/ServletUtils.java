...
public abstract class ServletUtils {
    ...
    public static void setFileDownloadHeader(HttpServletRequest request,
        ...
        try {
            ...
            if (null != agent) {
                ...
                if (agent.contains("firefox") || agent.contains("chrome") || agent.contains(
                        "safari")) {
                    encodedfileName = "filename=\"" + new String(fileName.getBytes(),
                            "ISO8859-1") + "\"";
    ...
    public static String encodeParameterStringWithPrefix(Map<String, Object> params,
        ...
        while (it.hasNext()) {
            ...
            queryStringBuilder.append(prefix).append(entry.getKey()).append('=').append(
                    entry.getValue());
            if (it.hasNext()) {
