 ...
 * @author Dave Syer
 */
public class LocalizeUserAuthenticationConverter implements UserAuthenticationConverter {
    ...
    private PrincipalSourceEnum userSource;

    public LocalizeUserAuthenticationConverter() {
    }


    public LocalizeUserAuthenticationConverter(PrincipalSourceEnum userSource) {
        this.userSource = userSource;
    }

    public void setUserSource(PrincipalSourceEnum userSource) {
        this.userSource = userSource;
    }
    ...
    public Map<String, ?> convertUserAuthentication(Authentication authentication) {
        ...
        securityUserDetails.getName();
        response.put(NICK_NAME, securityUserDetails.getName());
        response.put(FROM, userSource.toString());
