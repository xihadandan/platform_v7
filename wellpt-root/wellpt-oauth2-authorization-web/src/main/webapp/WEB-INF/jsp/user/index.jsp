        ...
        <div class="row">
            <div id="toolbar">
                <div class="form-inline" role="form">
                    ...
                    <button id="import" type="button" class="layui-btn layui-btn-sm">导入</button>
            ...
            <table id="table"
                ...
                <tr>
                    ...
                    <th data-field="accountNumber">用户账号</th>
                    <th data-field="createTime" data-formatter="dateFormatter">注册时间</th>
...
<script type="text/javascript" src="${base}assets/js/user/user-index.js"></script>
