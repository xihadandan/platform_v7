...
@Action(value = "平台二开示例--数据管理--学生操作")
public class StudentDmsDyformAction extends DyFormGetAction {
    ...
    @ActionConfig(name = "保存学生信息", id = "btn_demo_save_student_info", executeJsModule = "StudentDmsDyformAction", validate = true)
    @ResponseBody
