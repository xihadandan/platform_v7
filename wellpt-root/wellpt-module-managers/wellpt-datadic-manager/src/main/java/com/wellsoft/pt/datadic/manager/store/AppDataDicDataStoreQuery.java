package com.wellsoft.pt.datadic.manager.store;
 ...
 */
@Component
public class AppDataDicDataStoreQuery extends AbstractDataStoreQueryInterface {


    @Autowired
    AppDataDicFacadeService appDataDicFacadeService;
    ...
    public long count(QueryContext queryContext) {
        return appDataDicFacadeService.loadAppDataDicNodes("-1", queryContext.getQueryParams().get("moduleId").toString(), true).getTotal();
