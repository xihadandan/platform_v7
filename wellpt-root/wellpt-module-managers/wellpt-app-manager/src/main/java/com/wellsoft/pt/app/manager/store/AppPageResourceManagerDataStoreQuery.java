 ...
 */
@Component
public class AppPageResourceManagerDataStoreQuery extends AbstractDataStoreQueryInterface {
    ...
    public CriteriaMetadata initCriteriaMetadata(QueryContext queryContext) {
        ...
        criteriaMetadata.add("name", "t2.name", "名称", String.class);
        criteriaMetadata.add("id", "t2.id", "ID", String.class);
        criteriaMetadata.add("code", "t2.code", "编号", String.class);
        criteriaMetadata.add("type", "t2.type", "类型", String.class);
        criteriaMetadata.add("configType", "t1.config_type", "配置类型", String.class);
        criteriaMetadata.add("isProtected", "t1.is_protected", "资源是否受保护", Boolean.class);
        criteriaMetadata.add("remark", "t1.remark", "备注", String.class);
        criteriaMetadata.add("appPiUuid", "t1.app_pi_uuid", "产品集成信息UUID", String.class);
        criteriaMetadata.add("appPageUuid", "t1.app_page_uuid", "页面UUID", String.class);
        criteriaMetadata.add("appFunctionUuid", "t1.app_function_uuid", "功能UUID", String.class);
    ...
    public List<QueryItem> query(QueryContext queryContext) {
        List<QueryItem> queryItems = queryContext.getNativeDao().namedQuery("appPageResourceManagerQuery",
    ...
    public long count(QueryContext queryContext) {
        return queryContext.getNativeDao().countByNamedQuery("appPageResourceManagerQuery",
