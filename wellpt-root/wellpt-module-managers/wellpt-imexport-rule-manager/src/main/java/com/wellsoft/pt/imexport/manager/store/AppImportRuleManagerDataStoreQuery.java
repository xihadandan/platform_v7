package com.wellsoft.pt.imexport.manager.store;
 ...
 */
@Component
public class AppImportRuleManagerDataStoreQuery extends AbstractDataStoreQueryInterface {
    ...
    public CriteriaMetadata initCriteriaMetadata(QueryContext queryContext) {
        ...
        criteriaMetadata.add("entity", "t1.entity", "实体", String.class);
        criteriaMetadata.add("entityName", "t1.entity_name", "实体名称", String.class);
        criteriaMetadata.add("type", "t1.type", "类型", String.class);
        criteriaMetadata.add("startRow", "t1.start_row", "起始行", Integer.class);
    ...
    public List<QueryItem> query(QueryContext queryContext) {
        List<QueryItem> queryItems = queryContext.getNativeDao().namedQuery(
                "appModuleImportRuleManagerQuery",
    ...
    public long count(QueryContext queryContext) {
        ...
        return total != -1 ? total : queryContext.getNativeDao().countByNamedQuery(
                "appModuleImportRuleManagerQuery", getQueryParams(queryContext));
    }
