...
@Component
public class BasicdataMigrateMudule extends AbstractMigrateModule implements IMigrateModule {
    private static final String MODULE_NAME = "basicdata";

    public BasicdataMigrateMudule() {
        super(MODULE_NAME);
    }
