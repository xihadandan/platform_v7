...
@Component
public class PsiMigrateMudule extends AbstractMigrateModule implements IMigrateModule {
    private static final String MODULE_NAME = "psi";

    public PsiMigrateMudule() {
        super(MODULE_NAME);
    }
