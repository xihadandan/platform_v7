...
@Order(WellOrdered.NORMAL_PRECEDENCE)
@Component
public class CommonMigrateModule extends AbstractMigrateModule implements IMigrateModule, IMigrateCommon {
    public static final String MODULE_NAME = "tenant";
    public static final String JDBC_PREFIX = "multi.tenancy.common.";
    private Properties properties;

    public CommonMigrateModule() {
        super(MODULE_NAME);
    }
