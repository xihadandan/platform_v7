...
@Component
public class ScheduleMigrateModule extends AbstractMigrateModule implements IMigrateModule {
    private static final String MODULE_NAME = "schedule";

    public ScheduleMigrateModule() {
        super(MODULE_NAME);
    }
