...
@Order(WellOrdered.NORMAL_PRECEDENCE + 4)
@Component
public class MessageMigrateModule extends AbstractMigrateModule implements IMigrateModule, IMigrateCommon {
    public static final String MODULE_NAME = "message";
    public static final String JDBC_PREFIX = "multi.tenancy.cis.";
    private Properties properties;

    public MessageMigrateModule() {
        super(MODULE_NAME);
    }
