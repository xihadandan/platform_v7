 ...
 */
@Component
public class OrgParterSysCategoryListDataStoreQuery extends AbstractDataStoreQueryInterface {
    ...
    public CriteriaMetadata initCriteriaMetadata(QueryContext queryContext) {
        ...
        criteriaMetadata.add("iconStyle", "iconStyle", "图标样式", String.class);
    ...
    public List<QueryItem> query(QueryContext queryContext) {
        List<QueryItem> list = orgPartnerSysCategoryService.listQueryItemByNameSQLQuery("orgPartnerSysCategoryListKeywordQuery", getQueryParams(queryContext), queryContext.getPagingInfo());
    ...
    public long count(QueryContext queryContext) {
        return orgPartnerSysCategoryService.countByNamedSQLQuery("orgPartnerSysCategoryListKeywordQuery", getQueryParams(queryContext));
    }
