 ...
 */
@Component
public class UnitTreeJobCriterion extends AbstractUnitTreeCriterion {

    /**
     *
     */
    public UnitTreeJobCriterion() {
        super();
    }
     ...
     * @param ignoreCase
     */
    public UnitTreeJobCriterion(String columnIndex, Object value, String op, boolean ignoreCase) {
     ...
     * @param op
     */
    public UnitTreeJobCriterion(String columnIndex, Object value, String op) {
    ...
    public String getOrgType() {
        return UnitTreeServiceImpl.ID_JOB;
    }
