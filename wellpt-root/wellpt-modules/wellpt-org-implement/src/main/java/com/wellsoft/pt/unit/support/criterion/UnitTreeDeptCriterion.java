 ...
 */
@Component
public class UnitTreeDeptCriterion extends AbstractUnitTreeCriterion {

    /**
     *
     */
    public UnitTreeDeptCriterion() {
        super();
    }
     ...
     * @param ignoreCase
     */
    public UnitTreeDeptCriterion(String columnIndex, Object value, String op, boolean ignoreCase) {
     ...
     * @param op
     */
    public UnitTreeDeptCriterion(String columnIndex, Object value, String op) {
