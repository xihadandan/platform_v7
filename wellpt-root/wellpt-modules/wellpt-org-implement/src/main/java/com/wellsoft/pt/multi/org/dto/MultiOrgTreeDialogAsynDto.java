...
public class MultiOrgTreeDialogAsynDto {
    @ApiModelProperty("//类型")
    private String type;
    @ApiModelProperty("params")
    private OrgTreeDialLogAsynParms params;
    ...
    public OrgTreeDialLogAsynParms getParams() {
        return params;
    }

    public void setParams(OrgTreeDialLogAsynParms params) {
        this.params = params;
    }
}
