 ...
 * @date 2017-11-21
 */
public interface MultiOrgOptionDao extends JpaDao<MultiOrgOption, String> {
    Collection<MultiOrgOption> queryMultiOrgOptionsByLikeIdCodeName(String searchValue);
