...
import com.wellsoft.pt.org.iexport.acceptor.DepartmentIexportData;
...
public class DepartmentIexportDataProvider extends AbstractIexportDataProvider<Department, String> {

    static {
        TableMetaData.register(IexportType.Department, "部门", Department.class);
    }
    ...
    public IexportData getData(String uuid) {
        ...
        return new DepartmentIexportData(department);
    }

    @Override
    public String getTreeName(Department department) {
        return new DepartmentIexportData(department).getName();
    }
