 ...
 * @date 2015-7-8
 */
public class OrgUserGetRequest extends WellptRequest<OrgUserGetResponse> {
    ...
    public String getApiServiceName() {
        return ApiServiceName.ORG_USER_GET;
    }
     ...
     */
    @Override
    public Class<OrgUserGetResponse> getResponseClass() {
        return OrgUserGetResponse.class;
    }
