...
import static com.wellsoft.pt.org.unit.service.impl.UnitTreeServiceImpl.ATTRIBUTE_TYPE_JOB;
...
// @Component
@Deprecated
public class UnitTreeJobDataProvider extends AbstractUnitTreeDataProvider {
    ...
    public List<TreeType> getNodeTypes() {
        ...
        types.add(TreeType.createTreeType(ATTRIBUTE_TYPE_JOB, "职位"));
        return types;
    }
