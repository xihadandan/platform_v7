...
public class CustomSchemaExport {
    ...
    public CustomSchemaExport(ServiceRegistry serviceRegistry, Configuration configuration,
        ...
        this.sqlStatementLogger = serviceRegistry.getService(
                JdbcServices.class).getSqlStatementLogger();
        this.formatter = (sqlStatementLogger.isFormat() ? FormatStyle.DDL : FormatStyle.NONE).getFormatter();
        this.sqlExceptionHelper = serviceRegistry.getService(
    ...
    public CustomSchemaExport(ConnectionHelper connectionHelper, String[] dropSql,
                              String[] createSql) {
     ...
     * @return this
     */
    public CustomSchemaExport setImportSqlCommandExtractor(
            ImportSqlCommandExtractor importSqlCommandExtractor) {
    ...
    public void execute(Target output, Type type) {
        ...
        try {
            ...
            if (output.doExport()) {
                exporters.add(
                        new DatabaseExporter(connectionHelper, sqlExceptionHelper, this.uuid));
            }
    ...
    private void execute(boolean script, boolean export, Writer fileOutput, Statement statement,
                         final String sql)
