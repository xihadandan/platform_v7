...
import com.wellsoft.pt.dyform.support.validation.MaxLength;
...
public class MaxLengthValidator implements ConstraintValidator<MaxLength, Object> {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext constraintValidatorContext) {
        ...
        return value.toString().length() <= ValidationRuleModelContextHolder.getValidationRuleModel().getLength();
    }
