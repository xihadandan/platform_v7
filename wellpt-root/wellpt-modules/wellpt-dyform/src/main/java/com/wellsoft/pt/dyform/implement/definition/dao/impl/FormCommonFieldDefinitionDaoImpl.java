 ...
 * 修改记录:
 * 修改后版本	修改人		修改日期			修改内容
 * 2019年5月8日.1	zhongzh		2019年5月8日		Create
 * </pre>
 * @date 2019年5月8日
 */
@Repository
public class FormCommonFieldDefinitionDaoImpl extends AbstractJpaDaoImpl<FormCommonFieldDefinition, String>
        implements FormCommonFieldDefinitionDao {
}
