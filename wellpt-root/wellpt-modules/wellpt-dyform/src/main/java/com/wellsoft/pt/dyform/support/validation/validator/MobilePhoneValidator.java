...
import com.wellsoft.pt.dyform.support.validation.MobilePhone;
...
public class MobilePhoneValidator implements ConstraintValidator<MobilePhone, Object> {
     ...
     */
    @Override
    public void initialize(MobilePhone mobilePhoneAnnotation) {
    }
    ...
    public boolean isValid(Object value, ConstraintValidatorContext constraintValidatorContext) {
        ...
        return RegexUtils.isMobilePhone(value.toString());
    }
