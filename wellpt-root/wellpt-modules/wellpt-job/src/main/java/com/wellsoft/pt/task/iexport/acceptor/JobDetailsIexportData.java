 ...
 */
package com.wellsoft.pt.task.iexport.acceptor;
 ...
 * 修改记录:
 * 修改后版本	修改人		修改日期			修改内容
 * 2016-1-19.1	zhulh		2016-1-19		Create
 * </pre>
 * @date 2016年1月19日
 */
public class JobDetailsIexportData extends IexportData {
    public JobDetails jobDetails;

    public JobDetailsIexportData(JobDetails jobDetails) {
    ...
    public String getName() {
        return "任务：" + jobDetails.getName();
    }

    @Override
    public Integer getRecVer() {
        // TODO Auto-generated method stub
        return jobDetails.getRecVer();
    }
    ...
    public InputStream getInputStream() throws IOException {
        return IexportDataResultSetUtils.iexportDataResultSet2InputStream(this, jobDetails);
    }
