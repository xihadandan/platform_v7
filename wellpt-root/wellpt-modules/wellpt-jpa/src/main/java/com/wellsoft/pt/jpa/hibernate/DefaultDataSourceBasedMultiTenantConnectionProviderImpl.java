 ...
 */
public class DefaultDataSourceBasedMultiTenantConnectionProviderImpl extends
        AbstractDataSourceBasedMultiTenantConnectionProviderImpl implements ServiceRegistryAwareService, Stoppable,
     ...
     */
    private static final long serialVersionUID = -5434587291209294766L;
    ...
    public void injectServices(ServiceRegistryImplementor serviceRegistry) {
        ...
        if (DataSource.class.isInstance(namedObject)) {
            ...
            this.tenantIdentifierForAny = (String) serviceRegistry.getService(ConfigurationService.class).getSettings()
    ...
    public DataSource removeDataSource(String tenantIdentifier) {
        return dataSourceMap().remove(tenantIdentifier);
    }
