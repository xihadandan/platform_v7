...
public class NotNullExpression implements Criterion {
    ...
    protected NotNullExpression(String columnIndex) {
    ...
    public String toSqlString(Criteria criteria) {
        return criteria.getColumnName(columnIndex) + " is not null";
    }
    ...
    public org.hibernate.criterion.Criterion toHibernateCriterion() {
        return org.hibernate.criterion.Restrictions.isNotNull(columnIndex);
    }
