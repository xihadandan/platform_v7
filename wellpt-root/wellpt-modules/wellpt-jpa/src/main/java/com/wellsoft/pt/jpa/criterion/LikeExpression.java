...
public class LikeExpression implements Criterion {
    ...
    protected LikeExpression(String columnIndex, String value, MatchMode matchMode, boolean ignoreCase) {
        this(columnIndex, matchMode.toMatchString(value), ignoreCase);
    }

    protected LikeExpression(String columnIndex, String value, MatchMode matchMode) {
        this(columnIndex, matchMode.toMatchString(value), false);
    }

    protected LikeExpression(String columnIndex, String value, boolean ignoreCase) {
        this.columnIndex = columnIndex;
        this.value = value;
        this.ignoreCase = ignoreCase;
    }

    protected LikeExpression(String columnIndex, String value) {
    ...
    public String toSqlString(Criteria criteria) {
        ...
        if (ignoreCase) {
            return "lower(" + criteria.getColumnName(columnIndex) + ") like :" + paramsName;
        }
        return criteria.getColumnName(columnIndex) + " like :" + paramsName;
    }
