 ...
 */
@Repository
public class DXExchangeRouteDateDaoImpl extends AbstractJpaDaoImpl<DXExchangeRouteDate, String> implements
        DXExchangeRouteDateDao {
    ...
    public DXExchangeRouteDate getObjByUnitAndDataId(String unitId, String dataId, Integer recVer) {
        ...
        List<DXExchangeRouteDate> exchangeDataMonitors = listByHQL(hql, values);
    ...
    public List<String> getDistinctUnitList() {
        ...
        return getCharSequenceByHQL(hql, null);
    }
    ...
    public List<DXExchangeRouteDate> getDXExchangeDataReceiveByBatchId(String batchId) {
        String hql = "from DXExchangeDataReceive r where r.dXExchangeDataSend.dXExchangeData.dXExchangeDataBatch.id=:batchId";
        Map<String, Object> values = new HashMap<String, Object>();
