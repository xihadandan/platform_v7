...
@Service
@Transactional
public class SelfPublicModuleWSHSource extends AbstractViewDataSource {
    ...
    public Collection<ViewColumn> getAllViewColumns() {
        ...
        type.setAttributeName("selfPublicityApply.type");
    ...
    public List<QueryItem> query(Collection<ViewColumn> viewColumns, String whereHql, Map<String, Object> queryParams,
        ...
        List<CdDataDictionaryItemDto> dataDictionaries = basicDataApiFacade.getDataDictionariesByType("SELF_PUBLICITY_APPLY");
