...
import com.wellsoft.pt.bm.service.YZYHBusinessService;
 ...
 */
@Controller
@RequestMapping("/yzyh/business")
public class YZYHBusinessController {
    protected Logger logger = LoggerFactory.getLogger(getClass());
    @Autowired
    private CommercialBusinessService commercialBusinessService;
    @Autowired
    private UnitApiFacade unitApiFacade;
    //FIXME: YZYHBusinessService 实现类
    //@Autowired
    private YZYHBusinessService yZYHBusinessService;
    ...
    public void generateExcel(@RequestParam(value = "uuids") Collection<String> uuids, HttpServletRequest request,
                              HttpServletResponse response) {
        try {
            File file = yZYHBusinessService.generateExcel(uuids);
