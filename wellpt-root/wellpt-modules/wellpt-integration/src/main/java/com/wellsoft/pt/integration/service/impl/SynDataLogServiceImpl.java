...
import com.wellsoft.pt.integration.dao.SyncDataLogDao;
 ...
 */
@Service
public class SynDataLogServiceImpl extends AbstractJpaServiceImpl<SynDataLog, SyncDataLogDao, String> implements
        SynDataLogService {
