 ...
 * @date 2013-11-9
 */
public class DXCallBackService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        outProps.put("signaturePropFile", "ca/server-keystore.properties");
        ...
        inProps.put("decryptionPropFile", "ca/server-keystore.properties");
        inProps.put("signaturePropFile", "ca/server-keystore.properties");
        ...
        request.setUnitId("");
        // 调用WebService发送
        DXResponse response = webService.dxCallback(request);
