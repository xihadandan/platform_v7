...
import com.wellsoft.pt.integration.request.RouteCallbackRequest;
...
/**
 * Description: e、数据交换平台路由结束后回调源系统路由结果回调接口
 *
 * @author zhulh
 * @version 1.0
 *
...
public class Client5 {
    ...
    public static void main(String[] args) {
        ...
        RouteCallbackRequest message = new RouteCallbackRequest();
        // 上传时的批量ID
        message.setDataId("data123456798");
        // 数据版本号
        message.setRecVer(1);
        // 状态-成功1/失败0
        message.setCode(1);
        ...
        // 发送上传结果回调信息
        System.out.println(clientWebService.routeCallback(message));
    }
}
