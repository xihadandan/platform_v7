...
public class DXCancelClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DXCancelRequest dXCancelRequest = new DXCancelRequest();
        dXCancelRequest.setBatchId("DXBATCH20f49669-7818-4cbc-abb9-43243b6156d8");
        dXCancelRequest.setDataId("DXDATAID20140616001");
        dXCancelRequest.setFromId("004140203");
        dXCancelRequest.setMsg("发错了");
        dXCancelRequest.setRecVer(1);
        dXCancelRequest.setUnitId("004139106");
        DXResponse response = webService.dxCancel(dXCancelRequest);
        System.out.println(" 返回  ：BatchId = " + dXCancelRequest.getBatchId() + " Code = " + response.getCode()
                + " Msg=" + response.getMsg());
    }
