...
/**
 * Description: 数据库表LOG_BUSINESS_DETAILS的DAO接口实现类
 *
 * @author zhongzh
 * @version 1.0
 *
 ...
 */
@Repository
public class BusinessDetailsLogDaoImpl extends AbstractJpaDaoImpl<BusinessDetailsLog, String> implements BusinessDetailsLogDao {
