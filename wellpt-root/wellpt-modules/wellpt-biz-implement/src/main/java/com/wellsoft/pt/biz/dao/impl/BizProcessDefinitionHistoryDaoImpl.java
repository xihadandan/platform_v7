 ...
 */
@Repository
public class BizProcessDefinitionHistoryDaoImpl extends AbstractJpaDaoImpl<BizProcessDefinitionHistoryEntity, String> implements BizProcessDefinitionHistoryDao {
}
