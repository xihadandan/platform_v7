 ...
 * @date 12/7/23
 */
public class BizProcessNodeInstanceDyformStateChangedEvent extends ApplicationEvent {
    private static final long serialVersionUID = -8844067428419356206L;

    // 业务流程实例表单数据
    private DyFormData processNodeInstanceDyformData;
    // 状态名称字段
     ...
     */
    public BizProcessNodeInstanceDyformStateChangedEvent(Object source, DyFormData processNodeInstanceDyformData,
                                                         String stateNameField, String stateNameValue,
                                                         String stateCodeField, String stateCodeValue) {
        super(source);
        this.processNodeInstanceDyformData = processNodeInstanceDyformData;
    ...
    /**
     * @return the processNodeInstanceDyformData
     */
    public DyFormData getProcessNodeInstanceDyformData() {
        return processNodeInstanceDyformData;
    }
