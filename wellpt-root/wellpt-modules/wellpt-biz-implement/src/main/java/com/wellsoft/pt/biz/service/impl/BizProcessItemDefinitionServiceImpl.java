 ...
 */
@Service
public class BizProcessItemDefinitionServiceImpl extends AbstractJpaServiceImpl<BizProcessItemDefinitionEntity, BizProcessItemDefinitionDao, String> implements BizProcessItemDefinitionService {
     ...
     */
    @Override
    public List<BizProcessItemDefinitionEntity> listByProcessDefUuid(String processDefUuid) {
        Assert.hasText(processDefUuid, "业务流程定义UUID不能为空！");

        BizProcessItemDefinitionEntity entity = new BizProcessItemDefinitionEntity();
    ...
    public void deleteByProcessDefUuid(String processDefUuid) {
        ...
        String hql = "delete from BizProcessItemDefinitionEntity t where t.processDefUuid = :processDefUuid";
