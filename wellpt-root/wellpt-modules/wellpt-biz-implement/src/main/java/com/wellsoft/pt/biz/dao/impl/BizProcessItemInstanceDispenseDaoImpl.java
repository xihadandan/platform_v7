 ...
 */
@Repository
public class BizProcessItemInstanceDispenseDaoImpl extends AbstractJpaDaoImpl<BizProcessItemInstanceDispenseEntity, String>
        implements BizProcessItemInstanceDispenseDao {
}
