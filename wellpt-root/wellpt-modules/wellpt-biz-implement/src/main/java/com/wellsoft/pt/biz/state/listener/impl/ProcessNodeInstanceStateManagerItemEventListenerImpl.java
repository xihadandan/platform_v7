...
/**
 * Description: 过程节点办件状态管理——业务事项事件发生监听
 *
 * @author zhulh
 * @version 1.0
 *
 ...
 */
@Component
public class ProcessNodeInstanceStateManagerItemEventListenerImpl extends AbstractStateManagerProcessItemListener {
