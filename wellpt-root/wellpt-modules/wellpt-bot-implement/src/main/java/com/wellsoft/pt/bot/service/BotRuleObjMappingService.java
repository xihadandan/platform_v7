...
/**
 * Description: 数据库表BOT_RULE_OBJ_MAPPING的service服务接口
 *
 * @author chenq
 * @version 1.0
 *
 ...
 * @date 2018-09-14
 */
public interface BotRuleObjMappingService extends
        JpaService<BotRuleObjMappingEntity, BotRuleObjMappingDao, String> {

    List<BotRuleObjMappingEntity> listByConfUuid(String uuid);
