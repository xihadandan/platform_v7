 ...
 * @date 2016年3月16日
 */
public class ButtonRender extends AbstractCdFieldRender implements ICdFieldRender {
     ...
     * @param define
     */
    public ButtonRender(ICdFieldDefinition define) {
        super(define);
    }
    ...
    public String getTypeName() {
        return RenderEnum.button.getName();
    }
}
