...
public class TagWriter {
     ...
     * {@link IOException IOExceptions} in {@link RuntimeException RuntimeException}.
     */
    private static final class SafeWriter {
        ...
        public SafeWriter append(String value) {
            try {
                getWriterToUse().write(String.valueOf(value));
                return this;
            } catch (IOException ex) {
                // ignore
                throw new RuntimeException("Unable to write to StringWriter", ex);
            }
        }
