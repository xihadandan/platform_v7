 ...
 * @date 2016年3月16日
 */
public class TextRender extends AbstractCdFieldRender implements ICdFieldRender {
     ...
     * @param define
     */
    public TextRender(ICdFieldDefinition define) {
        super(define);
    }
    ...
    public String getTypeName() {
        return RenderEnum.text.getName();
    }
}
