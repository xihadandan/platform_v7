 ...
 * @date 2016年3月16日
 */
public class TextareaRender extends AbstractCdFieldRender implements ICdFieldRender {
     ...
     * @param define
     */
    public TextareaRender(ICdFieldDefinition define) {
        super(define);
    }
    ...
    public String getTypeName() {
        return RenderEnum.textarea.getName();
    }
}
