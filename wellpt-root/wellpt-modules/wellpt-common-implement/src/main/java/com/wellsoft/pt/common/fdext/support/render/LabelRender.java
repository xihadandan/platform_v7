 ...
 * @date 2016年3月16日
 */
public class LabelRender extends AbstractCdFieldRender implements ICdFieldRender {
     ...
     * @param define
     */
    public LabelRender(ICdFieldDefinition define) {
        super(define);
    }
    ...
    public String getTypeName() {
        return RenderEnum.label.getName();
    }
}
