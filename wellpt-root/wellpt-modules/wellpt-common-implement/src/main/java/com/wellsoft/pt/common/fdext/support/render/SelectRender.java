 ...
 * @date 2016年3月16日
 */
public class SelectRender extends CdFieldDictionaryRender {
     ...
     * @param define
     */
    public SelectRender(ICdFieldDefinition define) {
        super(define);
    }

    @Override
    public String getValue(Object data, Object value) {
        return contains(data, value) ? DEATULT_VALUE_SELECTED : "";
    }
    ...
    public String getTypeName() {
        return RenderEnum.select.getName();
    }
}
