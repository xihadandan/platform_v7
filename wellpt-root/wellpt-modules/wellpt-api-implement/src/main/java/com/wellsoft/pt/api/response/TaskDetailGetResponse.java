 ...
 * @date 2014-8-10
 */
public class TaskDetailGetResponse extends WellptResponse {

    /**
     * 如何描述serialVersionUID
     */
    private static final long serialVersionUID = 1131459547034876010L;
     ...
     * @param data 要设置的data
     */
    public void setData(TaskDetail data) {
        this.data = data;
    }
