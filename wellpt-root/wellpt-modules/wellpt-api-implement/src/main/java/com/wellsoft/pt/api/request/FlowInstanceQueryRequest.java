 ...
 * @date 2014-8-10
 */
public class FlowInstanceQueryRequest extends WellptQueryRequest<FlowInstanceQueryResponse> {
    ...
    public String getApiServiceName() {
        return ApiServiceName.FLOW_INSTANCE_QUERY;
    }
     ...
     */
    @Override
    public Class<FlowInstanceQueryResponse> getResponseClass() {
        return FlowInstanceQueryResponse.class;
    }
