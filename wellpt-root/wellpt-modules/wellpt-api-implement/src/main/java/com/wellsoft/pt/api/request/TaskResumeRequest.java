 ...
 * @date 2014-8-16
 */
public class TaskResumeRequest extends WellptRequest<TaskResumeResponse> {
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_RESUME;
    }
     ...
     */
    @Override
    public Class<TaskResumeResponse> getResponseClass() {
        return TaskResumeResponse.class;
    }
