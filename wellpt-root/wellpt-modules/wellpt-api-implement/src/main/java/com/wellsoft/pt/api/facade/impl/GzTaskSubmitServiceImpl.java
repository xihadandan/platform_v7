...
import com.wellsoft.pt.api.request.GzTaskSubmitRequest;
 ...
 * @date 2014-8-12
 */
@Service(ApiServiceName.GZ_TASK_SUBMIT)
@Transactional
public class GzTaskSubmitServiceImpl extends BaseServiceImpl implements WellptService<GzTaskSubmitRequest> {
     ...
     */
    @Override
    public synchronized WellptResponse doService(GzTaskSubmitRequest submitRequest) {
        // 任务实例UUID
        String flowInstUuid = submitRequest.getFlowInstUuid();
        // 目标环节ID
        ...
        GzTaskSubmitResponse response = new GzTaskSubmitResponse();
        return response;
    }
}
