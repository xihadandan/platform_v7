 ...
 * @date 2019年8月13日
 */
public class TaskCopyToRequest extends WellptRequest<TaskCopyToResponse> {
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_COPY_TO;
    }
     ...
     */
    @Override
    public Class<TaskCopyToResponse> getResponseClass() {
        return TaskCopyToResponse.class;
    }
