 ...
 * @date 2014-8-10
 */
public class TaskDetailForHlGetRequest extends WellptRequest<TaskDetailForHlGetResponse> {
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_DETAIL_GET_FOR_HL;
    }
     ...
     */
    @Override
    public Class<TaskDetailForHlGetResponse> getResponseClass() {
        return TaskDetailForHlGetResponse.class;
    }
