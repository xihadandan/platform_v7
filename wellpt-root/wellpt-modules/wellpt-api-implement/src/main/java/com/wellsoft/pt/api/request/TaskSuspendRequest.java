 ...
 * @date 2014-8-16
 */
public class TaskSuspendRequest extends WellptRequest<TaskSuspendResponse> {
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_SUSPEND;
    }
     ...
     */
    @Override
    public Class<TaskSuspendResponse> getResponseClass() {
        return TaskSuspendResponse.class;
    }
