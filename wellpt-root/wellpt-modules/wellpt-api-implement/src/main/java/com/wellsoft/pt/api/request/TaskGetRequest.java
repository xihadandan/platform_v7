 ...
 * @date 2014-8-10
 */
public class TaskGetRequest extends WellptRequest<TaskGetResponse> {
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_GET;
    }
     ...
     */
    @Override
    public Class<TaskGetResponse> getResponseClass() {
        return TaskGetResponse.class;
    }
