 ...
 * @date 2019年8月13日
 */
@Service(ApiServiceName.TASK_DELETE)
public class TaskDeleteServiceImpl implements WellptService<TaskDeleteRequest> {
     ...
     */
    @Override
    public WellptResponse doService(TaskDeleteRequest taskDeleteRequest) {
        String userId = SpringSecurityUtils.getCurrentUserId();
        String taskInstUuid = taskDeleteRequest.getUuid();
