 ...
 * @date 2014-8-10
 */
public class TaskCounterSignRequest extends WellptRequest<TaskCounterSignResponse> {
    // 任务实例UUID
    private String uuid;
    // 会签人员
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_COUNTER_SIGN;
    }
     ...
     */
    @Override
    public Class<TaskCounterSignResponse> getResponseClass() {
        return TaskCounterSignResponse.class;
    }
