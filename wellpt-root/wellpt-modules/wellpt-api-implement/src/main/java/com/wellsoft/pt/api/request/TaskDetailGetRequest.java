 ...
 * @date 2014-8-10
 */
public class TaskDetailGetRequest extends WellptRequest<TaskDetailGetResponse> {
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_DETAIL_GET;
    }
     ...
     */
    @Override
    public Class<TaskDetailGetResponse> getResponseClass() {
        return TaskDetailGetResponse.class;
    }
