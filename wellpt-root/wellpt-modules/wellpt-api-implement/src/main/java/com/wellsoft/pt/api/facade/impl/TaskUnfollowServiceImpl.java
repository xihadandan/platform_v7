 ...
 * @date 2019年8月13日
 */
@Service(ApiServiceName.TASK_UNFOLLOW)
public class TaskUnfollowServiceImpl implements WellptService<TaskUnfollowRequest> {
     ...
     */
    @Override
    public WellptResponse doService(TaskUnfollowRequest taskUnfollowRequest) {
        // String userId = SpringSecurityUtils.getCurrentUserId();
        String taskInstUuid = taskUnfollowRequest.getUuid();
        taskService.unfollow(taskInstUuid);
