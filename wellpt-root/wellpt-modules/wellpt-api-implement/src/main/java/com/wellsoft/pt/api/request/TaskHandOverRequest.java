 ...
 * @date 2019年8月13日
 */
public class TaskHandOverRequest extends WellptRequest<TaskHandOverResponse> {
    // 任务实例UUID
    private String uuid;
    // 移交人员ID
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_HAND_OVER;
    }
     ...
     */
    @Override
    public Class<TaskHandOverResponse> getResponseClass() {
        return TaskHandOverResponse.class;
    }
