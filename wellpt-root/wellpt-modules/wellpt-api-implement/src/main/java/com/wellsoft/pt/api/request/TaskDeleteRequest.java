 ...
 * @date 2019年8月13日
 */
public class TaskDeleteRequest extends WellptRequest<TaskDeleteResponse> {
    // 任务实例UUID
    private String uuid;
    ...
    public String getApiServiceName() {
        return ApiServiceName.TASK_DELETE;
    }
     ...
     */
    @Override
    public Class<TaskDeleteResponse> getResponseClass() {
        return TaskDeleteResponse.class;
    }
