...
import com.wellsoft.pt.api.request.TaskOverQueryRequest;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskOverQuery {
    ...
    public static void main(String[] args) {
        ...
        // 环节待办查询
        TaskOverQueryRequest taskOverQueryRequest = new TaskOverQueryRequest();
        // taskOverQueryRequest.setTitle("test4");
        TaskQueryResponse taskQueryResponse = wellptClient.execute(taskOverQueryRequest);
