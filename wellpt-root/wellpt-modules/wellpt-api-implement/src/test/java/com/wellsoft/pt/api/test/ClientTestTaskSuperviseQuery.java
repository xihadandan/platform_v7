...
import com.wellsoft.pt.api.request.TaskSuperviseQueryRequest;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskSuperviseQuery {
    ...
    public static void main(String[] args) {
        ...
        // 环节督办查询
        TaskSuperviseQueryRequest taskSuperviseQueryRequest = new TaskSuperviseQueryRequest();
        TaskQueryResponse taskQueryResponse = wellptClient.execute(taskSuperviseQueryRequest);
