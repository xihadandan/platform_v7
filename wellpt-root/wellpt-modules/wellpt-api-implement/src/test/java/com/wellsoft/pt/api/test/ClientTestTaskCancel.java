 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskCancel {
    ...
    public static void main(String[] args) {
        ...
        taskCancelRequest.setUuid("5b93c2f1-0073-4b31-ad10-963bf03261e4");
        TaskCancelResponse taskCancelResponse = wellptClient.execute(taskCancelRequest);
        System.out.println(taskCancelResponse);
        System.out.println(JsonUtils.object2Json(taskCancelResponse));
    }
