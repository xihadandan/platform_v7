...
import com.wellsoft.pt.api.request.TaskAttentionQueryRequest;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskAttentionQuery {
    ...
    public static void main(String[] args) {
        ...
        // 环节关注查询
        TaskAttentionQueryRequest taskAttentionQueryRequest = new TaskAttentionQueryRequest();
        //        taskAttentionQueryRequest.setTitle("aa");
        //        taskAttentionQueryRequest.setId("T835");
        //        taskAttentionQueryRequest.setName("事项");
        //        taskAttentionQueryRequest.setFlowDefinitionId("flow_itemsManage_itemFlow");
        //        taskAttentionQueryRequest.setFlowInstUuid("db1ada05-6ce1-4c50-8a51-58288f3290a6");
        TaskQueryResponse taskQueryResponse = wellptClient.execute(taskAttentionQueryRequest);
        System.out.println(taskQueryResponse);
        System.out.println(JsonUtils.object2Json(taskQueryResponse));
    }
