...
import com.wellsoft.pt.api.request.TaskReadQueryRequest;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskReadQuery {
    ...
    public static void main(String[] args) {
        ...
        // 环节已阅查询
        TaskReadQueryRequest taskReadQueryRequest = new TaskReadQueryRequest();
        TaskQueryResponse taskQueryResponse = wellptClient.execute(taskReadQueryRequest);
