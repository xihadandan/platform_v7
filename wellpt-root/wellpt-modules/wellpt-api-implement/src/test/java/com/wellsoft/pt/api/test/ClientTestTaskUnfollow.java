...
import com.wellsoft.pt.api.request.TaskUnfollowRequest;
import com.wellsoft.pt.api.response.TaskUnfollowResponse;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskUnfollow {
    ...
    public static void main(String[] args) {
        ...
        // 取消环节关注
        TaskUnfollowRequest taskUnfollowRequest = new TaskUnfollowRequest();
        taskUnfollowRequest.setUuid("5b93c2f1-0073-4b31-ad10-963bf03261e4");
        TaskUnfollowResponse taskUnfollowResponse = wellptClient.execute(taskUnfollowRequest);
        System.out.println(taskUnfollowResponse);
        System.out.println(JsonUtils.object2Json(taskUnfollowResponse));
    }
