...
import com.wellsoft.pt.api.request.TaskMonitorQueryRequest;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskMonitorQuery {
    ...
    public static void main(String[] args) {
        ...
        // 环节监控查询
        TaskMonitorQueryRequest taskMonitorQueryRequest = new TaskMonitorQueryRequest();
        TaskQueryResponse taskQueryResponse = wellptClient.execute(taskMonitorQueryRequest);
