...
import com.wellsoft.pt.api.response.TaskHandOverResponse;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskHandOver {
    ...
    public static void main(String[] args) {
        ...
        // 环节特送人员
        TaskHandOverRequest taskHandOverRequest = new TaskHandOverRequest();
        taskHandOverRequest.setUuid("5b93c2f1-0073-4b31-ad10-963bf03261e4");
        taskHandOverRequest.setOpinionName("同意");
        taskHandOverRequest.setOpinionValue("1");
        taskHandOverRequest.setOpinionText("特送人员测试");
        List<String> taskUsers = Lists.newArrayList();
        taskUsers.add("U0000000076");
        taskHandOverRequest.setTaskUsers(taskUsers);
        TaskHandOverResponse taskHandOverResponse = wellptClient.execute(taskHandOverRequest);
        System.out.println(taskHandOverResponse);
        System.out.println(JsonUtils.object2Json(taskHandOverResponse));
    }
