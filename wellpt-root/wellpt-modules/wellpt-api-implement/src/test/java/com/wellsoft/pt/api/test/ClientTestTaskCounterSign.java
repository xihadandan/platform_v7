 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskCounterSign {
    ...
    public static void main(String[] args) {
        ...
        // 环节会签
        TaskCounterSignRequest counterSignRequest = new TaskCounterSignRequest();
        counterSignRequest.setOpinionName("同意");
        counterSignRequest.setOpinionValue("1");
        counterSignRequest.setOpinionText("会签测试");
        counterSignRequest.setUuid("5b93c2f1-0073-4b31-ad10-963bf03261e4");
        List<String> taskUsers = Lists.newArrayList();
        taskUsers.add("U0000000076");
        counterSignRequest.setTaskUsers(taskUsers);
        TaskCounterSignResponse taskCounterSignResponse = wellptClient.execute(counterSignRequest);
        System.out.println(taskCounterSignResponse);
        System.out.println(JsonUtils.object2Json(taskCounterSignResponse));
    }
