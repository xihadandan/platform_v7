 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskRemind {
    ...
    public static void main(String[] args) {
        ...
        taskRemindRequest.setOpinionName("催办");
        taskRemindRequest.setOpinionValue("2");
        taskRemindRequest.setOpinionText("催办测试");
        taskRemindRequest.setUuid("5b93c2f1-0073-4b31-ad10-963bf03261e4");
        TaskRemindResponse taskRemindResponse = wellptClient.execute(taskRemindRequest);
        System.out.println(taskRemindResponse);
        System.out.println(JsonUtils.object2Json(taskRemindResponse));
    }
