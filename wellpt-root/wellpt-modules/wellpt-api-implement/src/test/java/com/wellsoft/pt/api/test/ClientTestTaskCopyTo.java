 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskCopyTo {
    ...
    public static void main(String[] args) {
        ...
        // 环节抄送
        TaskCopyToRequest taskCopyToRequest = new TaskCopyToRequest();
        taskCopyToRequest.setUuid("5b93c2f1-0073-4b31-ad10-963bf03261e4");
        List<String> taskUsers = Lists.newArrayList();
        taskUsers.add("U0000000059");
        taskCopyToRequest.setTaskUsers(taskUsers);
        TaskCopyToResponse taskCopyToResponse = wellptClient.execute(taskCopyToRequest);
        System.out.println(taskCopyToResponse);
        System.out.println(JsonUtils.object2Json(taskCopyToResponse));
    }
