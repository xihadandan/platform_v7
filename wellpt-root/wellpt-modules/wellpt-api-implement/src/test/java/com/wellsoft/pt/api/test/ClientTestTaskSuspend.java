 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskSuspend {
    ...
    public static void main(String[] args) {
        ...
        taskSuspendRequest.setUuid("99996905-6b61-4fcb-adbd-d6c630d6c334");
        TaskSuspendResponse taskSuspendResponse = wellptClient.execute(taskSuspendRequest);
        System.out.println(taskSuspendResponse);
        System.out.println(JsonUtils.object2Json(taskSuspendResponse));
    }
