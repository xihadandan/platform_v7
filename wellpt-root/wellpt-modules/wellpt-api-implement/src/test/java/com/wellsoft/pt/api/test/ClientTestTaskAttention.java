 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskAttention {
    ...
    public static void main(String[] args) {
        ...
        // 环节关注
        TaskAttentionRequest taskAttentionRequest = new TaskAttentionRequest();
        taskAttentionRequest.setUuid("5b93c2f1-0073-4b31-ad10-963bf03261e4");
        TaskAttentionResponse taskAttentionResponse = wellptClient.execute(taskAttentionRequest);
        System.out.println(taskAttentionResponse);
        System.out.println(JsonUtils.object2Json(taskAttentionResponse));
    }
