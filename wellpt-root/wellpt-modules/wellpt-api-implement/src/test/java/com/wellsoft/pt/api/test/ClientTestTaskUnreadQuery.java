...
import com.wellsoft.pt.api.request.TaskUnreadQueryRequest;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskUnreadQuery {
    ...
    public static void main(String[] args) {
        ...
        // 环节未阅查询
        TaskUnreadQueryRequest taskUnreadQueryRequest = new TaskUnreadQueryRequest();
        TaskQueryResponse taskQueryResponse = wellptClient.execute(taskUnreadQueryRequest);
