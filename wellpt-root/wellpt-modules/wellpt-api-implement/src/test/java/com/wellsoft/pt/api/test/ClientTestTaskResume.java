 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskResume {
    ...
    public static void main(String[] args) {
        ...
        taskResumeRequest.setUuid("99996905-6b61-4fcb-adbd-d6c630d6c334");
        TaskResumeResponse taskResumeResponse = wellptClient.execute(taskResumeRequest);
        System.out.println(taskResumeResponse);
        System.out.println(JsonUtils.object2Json(taskResumeResponse));
    }
