...
import com.wellsoft.pt.api.request.TaskDoneQueryRequest;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskDoneQuery {
    ...
    public static void main(String[] args) {
        ...
        // 环节待办查询
        TaskDoneQueryRequest taskDoneQueryRequest = new TaskDoneQueryRequest();
        TaskQueryResponse taskQueryResponse = wellptClient.execute(taskDoneQueryRequest);
