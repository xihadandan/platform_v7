...
import com.wellsoft.pt.api.request.TaskTodoQueryRequest;
 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskTodoQuery {
    ...
    public static void main(String[] args) {
        ...
        // 环节待办查询
        TaskTodoQueryRequest taskTodoQueryRequest = new TaskTodoQueryRequest();
        TaskQueryResponse taskQueryResponse = wellptClient.execute(taskTodoQueryRequest);
