 ...
 * @date 2019年8月13日
 */
public class ClientTestTaskGet {
    ...
    public static void main(String[] args) {
        ...
        taskGetRequest.setUuid("99996905-6b61-4fcb-adbd-d6c630d6c334");
        TaskGetResponse taskGetResponse = wellptClient.execute(taskGetRequest);
        System.out.println(taskGetResponse);
        System.out.println(JsonUtils.object2Json(taskGetResponse));
    }
