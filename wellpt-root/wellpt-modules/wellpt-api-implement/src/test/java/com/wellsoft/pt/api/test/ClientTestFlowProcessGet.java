 ...
 * @date 2019年8月13日
 */
public class ClientTestFlowProcessGet {
    ...
    public static void main(String[] args) {
        ...
        // 查询流程实例
        FlowProcessGetRequest flowProcessGetRequest = new FlowProcessGetRequest();
        flowProcessGetRequest.setFlowInstUuid("0f863d42-8d80-4d58-b4e0-0981cc3002af");
        FlowProcessGetResponse flowProcessGetResponse = wellptClient.execute(flowProcessGetRequest);
        System.out.println(flowProcessGetResponse);
        System.out.println(JsonUtils.object2Json(flowProcessGetResponse));
    }
