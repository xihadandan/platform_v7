...
/**
 * Description: 数据库表DI_DATA_PROCESSOR的service服务接口
 *
 * @author chenq
 * @version 1.0
 *
 ...
 * @date 2019-07-23
 */
public interface DiDataProcessorService extends
        JpaService<DiDataProcessorEntity, DiDataProcessorDao, String> {
