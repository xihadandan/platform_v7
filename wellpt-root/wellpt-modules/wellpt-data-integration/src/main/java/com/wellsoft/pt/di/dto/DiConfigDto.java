...
/**
 * Description: 数据库表DI_CONFIG的对应的DTO类
 *
 * @author chenq
 * @version 1.0
 *
 ...
 * @date 2019-07-23
 */
public class DiConfigDto implements Serializable {
    ...
    private DiDataConsumerEndpointDto consumerEndpoint;

    private DiDataProducerEndpointDto producerEndpoint;

    private List<DiDataProcessorDto> processorDtos = Lists.newArrayList();
    ...
    public DiDataConsumerEndpointDto getConsumerEndpoint() {
        return consumerEndpoint;
    }

    public void setConsumerEndpoint(DiDataConsumerEndpointDto consumerEndpoint) {
        this.consumerEndpoint = consumerEndpoint;
    }

    public DiDataProducerEndpointDto getProducerEndpoint() {
        return producerEndpoint;
    }

    public void setProducerEndpoint(DiDataProducerEndpointDto producerEndpoint) {
        this.producerEndpoint = producerEndpoint;
    }

    public List<DiDataProcessorDto> getProcessorDtos() {
        return processorDtos;
    }

    public void setProcessorDtos(List<DiDataProcessorDto> processorDtos) {
        this.processorDtos = processorDtos;
    }
