...
/**
 * Description: 数据库表DI_DATA_PROCESSOR_LOG的DAO接口实现类
 *
 * @author chenq
 * @version 1.0
 *
 ...
 */
@Repository
public class DiDataProcessorLogDaoImpl extends AbstractJpaDaoImpl<DiDataProcessorLogEntity, String> implements DiDataProcessorLogDao {
