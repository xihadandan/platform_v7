 ...
 * </pre>
 */
public class XmlConvert2DXCancelRequestTransform extends
        AbstractDataTransform<String, DXCancelRequest> {
    XStream xStream = new XStream(new Dom4JDriver());


    @Override
    public String name() {
        return "XML字符串转为数据交换注销请求_v1.0";
    }


    @Override
    public DXCancelRequest transform(String o) throws Exception {
        ...
        xStream.aliasField("UNITID", DXRequest.class, "unitId");

        return (DXCancelRequest) xStream.fromXML(o);
    }
