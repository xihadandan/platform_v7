 ...
 * @date 2015-6-16
 */
public class ResourceParentIexportData extends IexportData {
    public Resource resource;

    public ResourceParentIexportData(Resource resource) {
    ...
    public List<IexportData> getDependencies() {
        ...
        Resource resourceTemp = resource.getParent();
        if (resourceTemp != null) {
            dependencies.add(IexportDataProviderFactory.getDataProvider(IexportType.ResourceParent).getData(
                    resourceTemp.getUuid()));
        }
        return dependencies;
    }
