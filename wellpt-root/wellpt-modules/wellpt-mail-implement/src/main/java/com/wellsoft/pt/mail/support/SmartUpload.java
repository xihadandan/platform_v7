...
public class SmartUpload {
    ...
    private static final Log log = LogFactory.getLog(SmartUpload.class);
    ...
    public void upload() throws SmartUploadException, IOException, ServletException {
        ...
        do {
            ...
            if (isFile) {
                com.wellsoft.pt.mail.support.File newFile = new com.wellsoft.pt.mail.support.File();
    ...
    public void downloadFile(String sourceFilePathName, String contentType, String destFileName, int blockSize)
        ...
        if (sourceFilePathName == null)
            throw new IllegalArgumentException(String
                    .valueOf((new StringBuffer("File '")).append(sourceFilePathName).append("' not found (1040).")));
        ...
        if (option == 0) {
            if (isVirtual(path)) {
                ...
                if (path.endsWith(fileSeparator))
                    ...
                    path = String
                            .valueOf((new StringBuffer(String.valueOf(path))).append(fileSeparator).append(fileName));
                return path;
            }
            if (isPhysical) {
