...
import com.wellsoft.pt.webmail.webservice.request.WmWebmailInboxQueryRequest;
 ...
 * @date 2016年7月18日
 */
@Service(WmWebmailApiServiceName.WM_WEBMAIL_INBOX_QUERY)
@Transactional(readOnly = true)
public class WmWebmailInboxQueryWebServiceImpl extends BaseServiceImpl implements WellptService<WmWebmailInboxQueryRequest> {
     ...
     */
    @Override
    public WellptResponse doService(WmWebmailInboxQueryRequest request) {
        ...
        values.put("status", WmWebmailConstants.STATUS_RECEIVE_SUCCESS);
        values.put("queryValue", queryValue);
        List<WmMailbox> wmMailboxs = this.dao.namedQuery("wmWebmailInboxQuery", values, WmMailbox.class, pagingInfo);
    ...
    // return WmWebmailInboxQueryRequest.class;
    // }
