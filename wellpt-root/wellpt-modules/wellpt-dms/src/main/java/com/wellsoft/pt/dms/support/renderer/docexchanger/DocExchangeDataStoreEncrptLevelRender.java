 ...
 */
@Component
public class DocExchangeDataStoreEncrptLevelRender extends DocExchangeDataStoreRender {
    @Override
    public String doRenderData(String columnIndex, Object value, Map<String, Object> rowData,
                               String param) {
        return value != null ? DocExchangeEncryptionLevelEnum.get(
                Integer.parseInt(value.toString())).getName() : "";
    }

    @Override
    public String getType() {
        return "docExchangeDataStoreEncrptLevelRender";
    }

    @Override
    public String getName() {
        return "数据管理_文档交换_文档密级渲染器";
    }
}
