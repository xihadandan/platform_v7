...
import com.wellsoft.pt.dms.file.action.ShareFolderAction;
 ...
 */
@Component
public class ShareFolderActionExecutor extends
        AbstractFileActionExecutor<ShareFolderActionParam, ShareFolderActionResult> {
     ...
     */
    @Override
    public ShareFolderActionResult execute(ShareFolderActionParam param) {
        // 分享的文件UUID
        ...
        String shareUuid = dmsFileActionService.shareFolder(folderUuid, shareOrgId, shareOrgName);
        ShareFolderActionResult shareFolderActionResult = new ShareFolderActionResult();
        shareFolderActionResult.setShareUuid(shareUuid);
        return shareFolderActionResult;
    }

    public static class ShareFolderActionParam extends FileActionParam<ShareFolderAction> {
    ...
    public static class ShareFolderActionResult extends FileActionResult<ShareFolderAction> {
