...
public class DmsFileMyTagDataQueryImpl extends AbstractQuery<DmsFileMyTagDataQuery, QueryItem> implements
        DmsFileMyTagDataQuery {
     ...
     * (non-Javadoc)
     *
     * @see com.wellsoft.pt.dms.file.query.api.DmsFileMyTagDataQuery#setTagUuid(java.lang.String)
     */
    @Override
    ...
    private String getFileMyShareInfoQuery() {
        if (StringUtils.isBlank(folderUuid)) {
            return "dmsFileMyTagDataQuery";
        }
        return "dmsFileMyTagDataListFolderAndFilesQuery";
    }
     ...
     * (non-Javadoc)
     *
     * @see com.wellsoft.pt.dms.file.query.api.DmsFileMyTagDataQuery#where(java.lang.String, java.util.Map)
     */
    @Override
    public DmsFileMyTagDataQuery where(String whereSql, Map<String, Object> params) {
     ...
     * (non-Javadoc)
     *
     * @see com.wellsoft.pt.dms.file.query.api.DmsFileMyTagDataQuery#order(java.lang.String)
     */
    @Override
    public DmsFileMyTagDataQuery order(String order) {
     ...
     * (non-Javadoc)
     *
     * @see com.wellsoft.pt.dms.file.query.api.DmsFileMyTagDataQuery#getCriteriaMetadata()
     */
    @Override
