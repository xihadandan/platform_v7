 ...
 */
@Component
public class FileManagerThumbnailViewWithBootstrapTableDataView implements FileDataView {
    ...
    public String getName() {
        return "文件管理缩略视图 +BootstrapTable视图展示";
    }
    ...
    public String getType() {
        return "fileManagerThumbnailViewWithBootstrapTableDataView";
    }
