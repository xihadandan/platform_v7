...
/**
 * Description: 数据库表DMS_DOC_EXCHANGE_DYFORM的service服务接口
 *
 * @author yt
 * @version 1.0
 *
 ...
 * @date 2021-07-13
 */
public interface DmsDocExchangeDyformService extends JpaService<DmsDocExchangeDyformEntity, DmsDocExchangeDyformDao, String> {
     ...
     * @return
     */
    String saveOrUpdate(DmsDocExchangeDyformDto dyformDto);
}
