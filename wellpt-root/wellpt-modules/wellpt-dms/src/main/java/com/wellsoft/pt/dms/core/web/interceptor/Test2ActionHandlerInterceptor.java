 ...
 */
@Component
public class Test2ActionHandlerInterceptor extends ActionHandlerInterceptorAdapter {
     ...
     * (non-Javadoc)
     *
     * @see com.wellsoft.pt.dms.core.web.interceptor.ActionHandlerInterceptorAdapter#getOrder()
     */
    @Override
    public int getOrder() {
        return 2;
