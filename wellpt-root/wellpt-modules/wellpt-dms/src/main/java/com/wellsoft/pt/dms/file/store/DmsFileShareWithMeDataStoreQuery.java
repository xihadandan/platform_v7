 ...
 */
@Component
public class DmsFileShareWithMeDataStoreQuery extends AbstractDataStoreQueryInterface {
    ...
    public CriteriaMetadata initCriteriaMetadata(QueryContext queryContext) {
        return dmsFileServiceFacade.createFileShareWithMeQuery().getCriteriaMetadata();
    }
    ...
    public List<QueryItem> query(QueryContext queryContext) {
        DmsFileShareWithMeQuery dmsFileMyShareInfoQuery = preQuery(queryContext);
     ...
     * @return
     */
    private DmsFileShareWithMeQuery preQuery(QueryContext queryContext) {
        Map<String, Object> values = queryContext.getQueryParams();
        String folderUuid = (String) values.get("folderUuid");
        DmsFileShareWithMeQuery dmsFileQuery = dmsFileServiceFacade.createFileShareWithMeQuery();
