 ...
 */
@Component
public class DmsFileMyShareInfoDataStoreQuery extends AbstractDataStoreQueryInterface {
    ...
    public CriteriaMetadata initCriteriaMetadata(QueryContext queryContext) {
        return dmsFileServiceFacade.createFileMyShareInfoQuery().getCriteriaMetadata();
    }
    ...
    public List<QueryItem> query(QueryContext queryContext) {
        DmsFileMyShareInfoQuery dmsFileMyShareInfoQuery = preQuery(queryContext);
     ...
     * @return
     */
    private DmsFileMyShareInfoQuery preQuery(QueryContext queryContext) {
        Map<String, Object> values = queryContext.getQueryParams();
        String folderUuid = (String) values.get("folderUuid");
        DmsFileMyShareInfoQuery dmsFileQuery = dmsFileServiceFacade.createFileMyShareInfoQuery();
