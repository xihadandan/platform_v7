 ...
 * 修改记录:
 * 修改后版本	修改人		修改日期			修改内容
 * Feb 15, 2017.1	zhongzh		Feb 15, 2017		Create
 * </pre>
 * @date Feb 15, 2017
 */
@Component
public class LeftSidebarWithBootstrapTableDataView implements DataView {
    ...
    public String getType() {
        return "leftSidebarWithBootstrapTableDataView";
    }
