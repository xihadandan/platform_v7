 ...
 */
@Component
public class DmsDataPermissionLatestVersionDataStoreQuery extends AbstractDataStoreQueryInterface {
    ...
    public CriteriaMetadata initCriteriaMetadata(QueryContext queryContext) {
        ...
        if (StringUtils.isNotBlank(dpDefId)) {
            ...
            if (entity != null) {
                ...
                criteriaMetadata.add("max_version", "v.version", "最大版本号", DataType.D, "NUMBER");
            }
        }
    ...
    public List<QueryItem> query(QueryContext queryContext) {
        ...
        return dmsDataPermissionQueryService.queryLatestVersion(this.getDmsDataPermissionDefId(queryContext),
                queryContext);
    }
    ...
    public long count(QueryContext queryContext) {
        ...
        if (totalCount < 0) {
            totalCount = dmsDataPermissionQueryService.countLatestVersion(this.getDmsDataPermissionDefId(queryContext),
                    queryContext);
        }
        return totalCount;
    }
