 ...
 */
@Action("视图列表")
public class ListViewCopyAction extends OpenViewAction {
    ...
    @ListViewActionConfig(name = "复制", id = ListViewActions.ACTION_COPY, singleSelect = true, executeJsModule = "DmsListViewCopyAction")
    public String gotoCopy(String pkValue, HttpServletRequest request, HttpServletResponse response, Model model) {
