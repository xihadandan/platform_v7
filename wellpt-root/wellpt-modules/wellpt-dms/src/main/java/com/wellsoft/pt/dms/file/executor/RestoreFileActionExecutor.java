...
import com.wellsoft.pt.dms.file.action.RestoreFileAction;
 ...
 */
@Component
public class RestoreFileActionExecutor extends
        AbstractFileActionExecutor<RestoreFileActionParam, RestoreFileActionResult> {
     ...
     */
    @Override
    public RestoreFileActionResult execute(RestoreFileActionParam param) {
        ...
        if (StringUtils.isNotBlank(fileUuid)) {
            this.dmsFileActionService.restoreFile(fileUuid);
        } else {
            this.dmsFileActionService.restoreFileByFolderUuidAndDataUuid(folderUuid, dataUuid);
        }
        return new RestoreFileActionResult();
    }

    public static class RestoreFileActionParam extends FileActionParam<RestoreFileAction> {
    ...
    public static class RestoreFileActionResult extends FileActionResult<RestoreFileAction> {
