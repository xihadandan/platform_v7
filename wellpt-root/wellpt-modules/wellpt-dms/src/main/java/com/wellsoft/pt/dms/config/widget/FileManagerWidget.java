 ...
 * @date 2019年6月19日
 */
public class FileManagerWidget extends DefaultWidgetDefinitionProxyView {

    /**
     * @param widgetDefinition
     * @throws Exception
     */
    public FileManagerWidget(String widgetDefinition) throws Exception {
    ...
    public WidgetConfiguration getConfiguration() {
        return getConfiguration(DmsFileManagerConfiguration.class);
    }
