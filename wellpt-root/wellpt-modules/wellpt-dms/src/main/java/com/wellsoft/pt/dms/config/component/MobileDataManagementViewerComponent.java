 ...
 */
@Component
public class MobileDataManagementViewerComponent extends UIDesignComponent {

    /**
     * 如何描述TYPE
     */
    public static final String TYPE = "wMobileDataManagementViewer";
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_mobile_data_management_viewer.id",
                "widget_mobile_data_management_viewer");
