 ...
 * @date Feb 1, 2018
 */
public interface DmsFileMyTagDataQuery extends Query<DmsFileMyTagDataQuery, QueryItem> {
    ...
    DmsFileMyTagDataQuery where(String whereSql, Map<String, Object> params);

    DmsFileMyTagDataQuery order(String order);
