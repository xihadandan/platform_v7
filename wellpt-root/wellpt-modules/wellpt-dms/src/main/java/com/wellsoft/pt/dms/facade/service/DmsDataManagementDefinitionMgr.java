 ...
 * @date 2017-02-13
 */
public interface DmsDataManagementDefinitionMgr extends BaseService {
     ...
     * @return
     */
    DmsDataManagementDefinitionBean getBean(String uuid);
     ...
     * @return
     */
    void saveBean(DmsDataManagementDefinitionBean bean);
