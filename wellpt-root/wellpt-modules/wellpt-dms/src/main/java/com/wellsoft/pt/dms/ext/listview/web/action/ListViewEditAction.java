 ...
 */
@Action("视图列表")
public class ListViewEditAction extends OpenViewAction {
    ...
    @ListViewActionConfig(name = "编辑", id = ListViewActions.ACTION_EDIT, executeJsModule = "DmsListViewEditAction")
    public String gotoAdd(String pkValue, HttpServletRequest request, HttpServletResponse response, Model model) {
