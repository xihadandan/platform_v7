...
public class DataMarkQueryRequest implements Serializable {
    ...
    public List<MarkType> getTypes() {
        return types;
    }

    public void setTypes(List<MarkType> types) {
        this.types = types;
    }
}
