 ...
 */
@Component
public class BarChartComponent extends UIDesignComponent {
    @Override
    public JavaScriptModule getJavaScriptModule() {
        return getJavaScriptModule("pt.js.module.widget_bar_chart.id",
                "widget_bar_chart");
    }

    @Override
    public String getType() {
        return ReportComponentEnum.BAR_CHART.getType();
    }

    @Override
    public String getName() {
        return ReportComponentEnum.BAR_CHART.getName();
    }
    ...
    @Override
    public int getOrder() {
        return ReportComponentEnum.BAR_CHART.ordinal();
    }
}