 ...
 */
@Component
public class DbFileReportProvider implements ReportProvider {

    private final static String FILE_PREFIX = "db:";
    ...
    public List<ReportFile> getReportFiles() {
        return rpFileRepositoryService.getAllReportFiles(null);
    ...
    public void saveReport(String file, String content) {
        rpFileRepositoryService.saveRpFile(getRealFileName(file), content, null);
    }
