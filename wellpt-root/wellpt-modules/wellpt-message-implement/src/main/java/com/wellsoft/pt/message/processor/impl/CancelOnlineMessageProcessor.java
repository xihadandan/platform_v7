 ...
 */
@Component
public class CancelOnlineMessageProcessor extends AbstractMessageProcessor {
    @Autowired
    ...
    public void doProcessor(Message msg) {
        String dataUuid = msg.getDataUuid();
        messageInboxService.removeMessageByOutUuid(dataUuid);
    }
}
