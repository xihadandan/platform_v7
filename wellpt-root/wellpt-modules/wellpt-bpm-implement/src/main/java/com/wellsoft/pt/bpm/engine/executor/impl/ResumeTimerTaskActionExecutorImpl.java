...
import com.wellsoft.pt.bpm.engine.executor.ResumeTimerTaskActionExecutor;
...
@Service
@Transactional
public class ResumeTimerTaskActionExecutorImpl extends TaskActionExecutor implements ResumeTimerTaskActionExecutor {
