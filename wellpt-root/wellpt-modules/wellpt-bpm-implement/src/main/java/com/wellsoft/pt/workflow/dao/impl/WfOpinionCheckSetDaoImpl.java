...
/**
 * Description: 数据库表WF_OPINION_CHECK_SET的DAO接口实现类
 *
 * @author zenghw
 * @version 1.0
 *
 ...
 */
@Repository
public class WfOpinionCheckSetDaoImpl extends AbstractJpaDaoImpl<WfOpinionCheckSetEntity, String> implements WfOpinionCheckSetDao {
