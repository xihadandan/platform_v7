...
import com.wellsoft.pt.bpm.engine.executor.RemindTaskActionExecutor;
...
@Service
@Transactional
public class RemindTaskActionExecutorImpl extends TaskActionExecutor implements RemindTaskActionExecutor {
