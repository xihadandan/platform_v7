 ...
 * @date 2015-6-16
 */
public class FlowCategoryIexportData extends IexportData {
    public FlowCategory flowCategory;

    public FlowCategoryIexportData(FlowCategory flowCategory) {
    ...
    public String getName() {
        return "流程分类：" + flowCategory.getName();
    }

    @Override
    public Integer getRecVer() {
        return flowCategory.getRecVer();
    }
    ...
    public InputStream getInputStream() throws IOException {
        return IexportDataResultSetUtils.iexportDataResultSet2InputStream(this, flowCategory);
    }
