 ...
 * @date 2014-11-11
 */
public class CancelTaskTransitionHanlderImpl extends AbstractHandler implements CancelTaskTransitionHanlder {

    public void execute(CancelTaskTransition transition, ExecutionContext executionContext) {
    }
}
