...
import com.wellsoft.pt.bpm.engine.executor.UnfollowTaskActionExecutor;
...
@Service
@Transactional
public class UnfollowTaskActionExecutorImpl extends TaskActionExecutor implements UnfollowTaskActionExecutor {
