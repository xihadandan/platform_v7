...
import com.wellsoft.pt.bpm.engine.executor.SuspendTaskActionExecutor;
...
@Service
@Transactional
public class SuspendTaskActionExecutorImpl extends TaskActionExecutor implements SuspendTaskActionExecutor {
