...
import com.wellsoft.pt.bpm.engine.executor.SignOpinionTaskActionExecutor;
...
@Service
@Transactional
public class SignOpinionTaskActionExecutorImpl extends TaskActionExecutor implements SignOpinionTaskActionExecutor {
