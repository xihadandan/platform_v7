...
import com.wellsoft.pt.bpm.engine.executor.AttentionTaskActionExecutor;
...
@Service
@Transactional
public class AttentionTaskActionExecutorImpl extends TaskActionExecutor implements AttentionTaskActionExecutor {
