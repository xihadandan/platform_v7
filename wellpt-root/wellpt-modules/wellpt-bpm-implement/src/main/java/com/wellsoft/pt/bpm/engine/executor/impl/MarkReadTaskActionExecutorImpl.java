...
import com.wellsoft.pt.bpm.engine.executor.MarkReadTaskActionExecutor;
...
@Service
@Transactional
public class MarkReadTaskActionExecutorImpl extends TaskActionExecutor implements MarkReadTaskActionExecutor {
