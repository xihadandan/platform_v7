...
import com.wellsoft.pt.bpm.engine.executor.RejectTaskActionExecutor;
...
@Service
@Transactional
public class RejectTaskActionExecutorImpl extends TaskActionExecutor implements RejectTaskActionExecutor {
