...
import com.wellsoft.pt.bpm.engine.executor.ResumeTaskActionExecutor;
...
@Service
@Transactional
public class ResumeTaskActionExecutorImpl extends TaskActionExecutor implements ResumeTaskActionExecutor {
