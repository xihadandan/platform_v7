 ...
 * @date 2015-8-13
 */
public class ResourceByTableModel extends AbstractModel {
    private static final int MODELCODE = Type.OUTPUTTYPE_RESOURCE;
    ...
    public void work(Context context) {
        ...
        for (Map.Entry<String, List<TableSource.Column>> entry : source.getTables().entrySet()) {
            ...
            ApplicationContextHolder.getBean(ResourceGeneratorService.class).generate(context,
                    tableName);
        }
