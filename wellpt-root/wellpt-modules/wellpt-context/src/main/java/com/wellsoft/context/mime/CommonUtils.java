 ...
 * @date 2013-12-19 下午4:52:04
 * @version V1.0
 */
package com.wellsoft.context.mime;
...
public class CommonUtils {
     ...
     * @Fields fus : TODO
     */
    public static CommonUtils fus = null;
     ...
     * @return
     * @Title: dateFormat
     * @Description: format datetime string by pattern;
     */
    public static String dateFormat(Date date, String patterm) {
     ...
     * @Description: TODO
     */
    public String getFileMD5String(String fileName) throws Exception {
        int bSzie = 1024;
        byte b[] = new byte[bSzie];// 暂存容器
     ...
     * @Description: TODO
     */
    public String getFileMD5String(InputStream is) throws Exception {
        int bSzie = 1024;
        byte b[] = new byte[bSzie];// 暂存容器
        int n = 0;
        try {
            MessageDigest md = MessageDigest.getInstance("MD5");
            while ((n = is.read(b, 0, bSzie)) > 0) {
                md.update(b, 0, n);
            }
