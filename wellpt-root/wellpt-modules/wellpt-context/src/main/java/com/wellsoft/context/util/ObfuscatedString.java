...
public final class ObfuscatedString {
    ...
    private static final String UTF8 = new String(new char[]{'\u0055', '\u0054', '\u0046', '\u0038'}); // => "UTF8"
    /**
    ...
    public static String obfuscate(final String s) {
        ...
        if (-1 != s.indexOf(0)) {
            throw new IllegalArgumentException(new ObfuscatedString(new long[]{0x241005931110FC70L,
                    0xDCD925A88EAD9F37L, 0x19ADA1C861E2A85DL, 0x9A5948E700FCAD8AL, 0x2E11C83A72441DE2L}).toString()); // => "Null characters are not allowed!";
        }
        ...
        final StringBuffer code = new StringBuffer(new ObfuscatedString(
                new long[]{0xA28E32BB0D3E394EL, 0xF842D1C94E549EECL, 0x7D07DFF01F907E4L, 0x4E0BDE791ECD467CL,
                        0xDFF389B58DA3E44FL, 0x2477FAED0CE62C79L}).toString()); // => "new ObfuscatedString(new long[] {";
        ...
        code.append(new ObfuscatedString(new long[]{0x4200B7AD6FFFF546L, 0x9B822E95FE73769DL, 0x23C2800C6CACFCE3L,
        ...
        code.append(s
                .replaceAll("\\\\",
                        new ObfuscatedString(new long[]{0x6D2C680D49523A01L, 0xB932F1DBD19E82CEL}).toString() /* => "\\\\\\\\" */)
                .replaceAll("\"",
                        new ObfuscatedString(new long[]{0x85E9D53EF7A9324BL, 0xB05BD65C9F19DE07L}).toString() /* => "\\\\\"" */));

        code.append(new ObfuscatedString(new long[]{0xC54FFF0621E7D107L, 0x194EAD468C6FCF93L}).toString()); // => "\" */"
