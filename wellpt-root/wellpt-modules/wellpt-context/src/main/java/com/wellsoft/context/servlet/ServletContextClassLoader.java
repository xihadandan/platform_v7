...
public class ServletContextClassLoader extends ClassLoader {
    ...
    public static final String mdbLocationPattern = new ObfuscatedString(new long[]{0x138F9CD068E41229L, 0x5593C38603C16C87L,
    ...
    public static final String cdbLocationPattern = new ObfuscatedString(new long[]{0xCD8278DA14A441EAL, 0x3C8B9996A3BA4D46L,
    ...
    private Logger logger = LoggerFactory.getLogger(ServletContextClassLoader.class);
     ...
     * @param parent
     */
    public ServletContextClassLoader(ClassLoader parent, Resource[] mdbResources, Resource[] cdbResources) {
        super(parent);
