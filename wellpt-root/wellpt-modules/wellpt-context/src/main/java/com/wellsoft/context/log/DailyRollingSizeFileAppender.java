package com.wellsoft.context.log;
...
/**
 * Description: 日志文件按日期与文件大小滚动
 * 结合了DailyRollingFileAppender与RollingFileAppender
 *
 * @author chenq
 * @date 2018/12/28
 *
 ...
 * 修改记录:
 * 修改后版本	    修改人		修改日期			修改内容
 * 2018/12/28    chenq		2018/12/28		Create
 * </pre>
 */
public class DailyRollingSizeFileAppender extends FileAppender {
    ...
    /**
     * There is nolimite backup file by default.
     */
     ...
     */
    public DailyRollingSizeFileAppender() {
    }

    /**
     * Instantiate a <code>DailyRollingSizeFileAppender</code> and open the file
     * designated by <code>filename</code>. The opened filename will become the
     * ouput destination for this appender.
     */
    public DailyRollingSizeFileAppender(Layout layout, String filename,
    ...
    /**
     * This method differentiates DailyRollingSizeFileAppender from its super class.
     * <p>
     * <p>
    ...
    protected void subAppend(LoggingEvent event) {
        ...
        if (n >= nextCheck && maxBackupIndex <= 0) {
            now.setTime(n);
    ...
    class RollingCalendar extends GregorianCalendar {
        ...
        int type = DailyRollingSizeFileAppender.TOP_OF_TROUBLE;
        ...
        public Date getNextCheckDate(Date now) {
            ...
            switch (type) {
                case DailyRollingSizeFileAppender.TOP_OF_MINUTE:
                    this.set(Calendar.SECOND, 0);
                    this.set(Calendar.MILLISECOND, 0);
                    this.add(Calendar.MINUTE, 1);
                    break;
                case DailyRollingSizeFileAppender.TOP_OF_HOUR:
                    this.set(Calendar.MINUTE, 0);
                    this.set(Calendar.SECOND, 0);
                    this.set(Calendar.MILLISECOND, 0);
                    this.add(Calendar.HOUR_OF_DAY, 1);
                    break;
                case DailyRollingSizeFileAppender.HALF_DAY:
                    this.set(Calendar.MINUTE, 0);
                    this.set(Calendar.SECOND, 0);
                    this.set(Calendar.MILLISECOND, 0);
                    ...
                    break;
                case DailyRollingSizeFileAppender.TOP_OF_DAY:
                    this.set(Calendar.HOUR_OF_DAY, 0);
                    this.set(Calendar.MINUTE, 0);
                    this.set(Calendar.SECOND, 0);
                    this.set(Calendar.MILLISECOND, 0);
                    ...
                    break;
                case DailyRollingSizeFileAppender.TOP_OF_WEEK:
                    ...
                    break;
                case DailyRollingSizeFileAppender.TOP_OF_MONTH:
