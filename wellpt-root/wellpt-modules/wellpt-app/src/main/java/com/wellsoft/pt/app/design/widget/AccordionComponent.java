...
import com.wellsoft.pt.app.ui.client.widget.AccordionWidget;
 ...
 */
@Component
public class AccordionComponent extends UIDesignComponent {
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_accordion.id", "widget_accordion");
    ...
    public List<CssFile> getDefineCssFiles() {
        ...
        cssFiles.add(getCssFile("pt.css.wAccordion.id", "wAccordion"));
        return cssFiles;
    }
