...
public class DataDictionaryAppFunctionSourceLoader extends AbstractAppFunctionSourceLoader {
    ...
    public String getAppFunctionType() {
        return AppFunctionType.DataDictionary;
    }
    ...
    public List<AppFunctionSource> getAppFunctionSources() {
        List<AppFunctionSource> appFunctionSources = new ArrayList<AppFunctionSource>();
        List<DataDictionary> dataDictionaries = this.dao.getAll(DataDictionary.class);
    ...
    public <ITEM extends Serializable> AppFunctionSource convert2AppFunctionSource(ITEM item) {
        DataDictionary dataDictionary = (DataDictionary) item;
        String uuid = dataDictionary.getUuid();
