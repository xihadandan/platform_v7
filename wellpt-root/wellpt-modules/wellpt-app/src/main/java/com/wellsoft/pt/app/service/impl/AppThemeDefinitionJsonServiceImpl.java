 ...
 */
@Service
public class AppThemeDefinitionJsonServiceImpl extends AbstractJpaServiceImpl<AppThemeDefinitionJsonEntity, AppThemeDefinitionJsonDao, String>
        implements AppThemeDefinitionJsonService {
}
