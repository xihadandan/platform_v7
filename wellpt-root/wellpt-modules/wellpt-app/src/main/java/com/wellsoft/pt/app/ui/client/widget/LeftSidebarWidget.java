...
import com.wellsoft.pt.app.ui.client.widget.configuration.LeftSidebarConfiguration;
 ...
 * @date 2016-10-21
 */
public class LeftSidebarWidget extends DefaultWidgetDefinitionProxyView {
     ...
     * @throws Exception
     */
    public LeftSidebarWidget(String widgetDefinition) throws Exception {
    ...
    private void filterNavAuthority(List<Map<String, Object>> navs,
        ...
        for (Map<String, Object> map : navs) {
            ...
            if (dataMap != null && dataMap.size() > 0) {
                ...
                // 2.导航功能元素权限判断
                // 组件元素功能UUID
                String uuid = ObjectUtils.toString(dataMap.get(AppConstants.KEY_UUID),
                        StringUtils.EMPTY);
                String functionUuid = DigestUtils.md5Hex(uuid + getAttribute(AppConstants.KEY_ID));
    ...
    public WidgetConfiguration getConfiguration() {
        return getConfiguration(LeftSidebarConfiguration.class);
    }
