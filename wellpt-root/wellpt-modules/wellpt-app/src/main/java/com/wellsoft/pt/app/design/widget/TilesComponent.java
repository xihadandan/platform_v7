...
import com.wellsoft.pt.app.ui.client.widget.TilesWidget;
 ...
 * 修改记录:
 * 修改后版本	修改人		修改日期			修改内容
 * 2016年8月31日.1	zhulh		2016年8月31日		Create
 * </pre>
 * @date 2016年8月31日
 */
@Component
public class TilesComponent extends UIDesignComponent {
    ...
    public JavaScriptModule getJavaScriptModule() {
        return getJavaScriptModule("pt.js.module.wTiles.id", "widget_tiles");
    }
    ...
    public List<CssFile> getExplainCssFiles() {
        ...
        cssFiles.add(getCssFile("pt.css.wTiles.id", "wTiles"));
        return cssFiles;
    }
