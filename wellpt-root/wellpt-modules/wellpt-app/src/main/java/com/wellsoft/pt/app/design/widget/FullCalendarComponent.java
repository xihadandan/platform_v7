...
import com.wellsoft.pt.app.ui.client.widget.FullCalendarWidget;
 ...
 */
@Component
public class FullCalendarComponent extends UIDesignComponent {

    @SuppressWarnings("unchecked")
    @Override
    public Class<? extends View> getViewClass() {
        return FullCalendarWidget.class;
    }

    @Override
    public String getType() {
        return "wFullCalendar";
    }
    ...
    public JavaScriptModule getJavaScriptModule() {
        return getJavaScriptModule("pt.js.module.widget_fullcalendar.id", "widget_fullcalendar");
    }
