...
import com.wellsoft.pt.app.ui.client.widget.mobile.MobileGridViewWidget;
 ...
 */
@Component
public class MobileGridViewComponent extends UIDesignComponent {
    ...
    public Class<? extends View> getViewClass() {
        return MobileGridViewWidget.class;
    }
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_mobile_grid_view.id", "widget_mobile_grid_view");
