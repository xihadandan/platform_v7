...
import com.wellsoft.pt.app.ui.client.widget.configuration.AccordionConfiguration;

/**
 * Description: 手风琴组件解析类
 *
 * @author zhulh
 * @version 1.0
 *
 ...
 * @date 2020年12月15日
 */
public class AccordionWidget extends DefaultWidgetDefinitionProxyView {

    /**
     * @param widgetDefinition
     * @throws Exception
     */
    public AccordionWidget(String widgetDefinition) throws Exception {
    ...
    public WidgetConfiguration getConfiguration() {
        return super.getConfiguration(AccordionConfiguration.class);
    }
