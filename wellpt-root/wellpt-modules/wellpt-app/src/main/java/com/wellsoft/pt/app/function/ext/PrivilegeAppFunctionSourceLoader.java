...
public class PrivilegeAppFunctionSourceLoader extends AbstractAppFunctionSourceLoader {
    ...
    public String getAppFunctionType() {
        return AppFunctionType.Privilege;
    }
    ...
    public List<AppFunctionSource> getAppFunctionSources() {
        ...
        List<Privilege> privileges = this.dao.getAll(Privilege.class);
        for (Privilege privilege : privileges) {
            appFunctionSources.add(convert2AppFunctionSource(privilege));
        }
    ...
    public <ITEM extends Serializable> AppFunctionSource convert2AppFunctionSource(ITEM item) {
        ...
        String fullName = privilege.getName() + "_" + privilege.getCode();
        String name = "权限_" + privilege.getName();
        String id = privilege.getCode();
