...
import com.wellsoft.pt.app.ui.client.widget.StepNavWidget;
 ...
 */
@Component
public class StepNavComponent extends UIDesignComponent {
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_step_nav.id", "widget_step_nav");
    ...
    public List<CssFile> getDefineCssFiles() {
        ...
        cssFiles.add(getCssFile("pt.css.wStepNav.id", "wStepNav"));
        return cssFiles;
    }
