...
import com.wellsoft.pt.app.ui.client.widget.NavbarWidget;
 ...
 */
@Component
public class NavbarComponent extends UIDesignComponent {
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_navbar.id", "widget_navbar");
