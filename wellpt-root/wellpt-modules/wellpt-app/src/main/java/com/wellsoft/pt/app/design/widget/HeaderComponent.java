 ...
 */
@Component
public class HeaderComponent extends UIDesignComponent {
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_header.id", "widget_header");
    ...
    public List<CssFile> getDefineCssFiles() {
        ...
        cssFiles.add(getCssFile("pt.css.wHeader.id", "wHeader"));
        return cssFiles;
    }
