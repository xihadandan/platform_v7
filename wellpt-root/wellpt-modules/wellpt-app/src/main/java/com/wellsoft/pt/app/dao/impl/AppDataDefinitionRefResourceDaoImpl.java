 ...
 */
@Repository
public class AppDataDefinitionRefResourceDaoImpl extends AbstractJpaDaoImpl<AppDataDefinitionRefResourceEntity, Long> implements AppDataDefinitionRefResourceDao {
}
