...
@ApiModel("应用主题")
@Entity
@Table(name = "APP_THEME_DEFINITION_HIS")
@DynamicUpdate
@DynamicInsert
public class AppThemeDefinitionHisEntity extends TenantEntity {
    private static final long serialVersionUID = 8581060571001427123L;

    @ApiModelProperty("主题定义UUID")
    private String themeDefUuid;
    @ApiModelProperty("名称")
    private String name;
    @ApiModelProperty("ID")
    private String id;
    ...
    /**
     * @return the themeDefUuid
     */
    public String getThemeDefUuid() {
        return themeDefUuid;
    }

    /**
     * @param themeDefUuid 要设置的themeDefUuid
     */
    public void setThemeDefUuid(String themeDefUuid) {
        this.themeDefUuid = themeDefUuid;
    }
