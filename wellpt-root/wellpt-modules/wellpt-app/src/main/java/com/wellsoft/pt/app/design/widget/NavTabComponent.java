 ...
 */
@Component
public class NavTabComponent extends UIDesignComponent implements Container {
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_nav_tab.id", "widget_nav_tab");
    ...
    public List<CssFile> getDefineCssFiles() {
        ...
        cssFiles.add(getCssFile("pt.css.wNavTab.id", "wNavTab"));
        return cssFiles;
    }
