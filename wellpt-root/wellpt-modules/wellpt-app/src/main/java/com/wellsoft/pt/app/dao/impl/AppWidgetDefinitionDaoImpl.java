 ...
 */
@Repository
public class AppWidgetDefinitionDaoImpl extends AbstractJpaDaoImpl<AppWidgetDefinition, String> implements
        AppWidgetDefinitionDao {
