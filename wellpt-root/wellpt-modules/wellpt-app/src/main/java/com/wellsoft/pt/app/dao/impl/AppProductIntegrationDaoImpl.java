 ...
 */
@Repository
public class AppProductIntegrationDaoImpl extends AbstractJpaDaoImpl<AppProductIntegration, String> implements
        AppProductIntegrationDao {
