...
public class MessageTemplateAppFunctionSourceLoader extends AbstractAppFunctionSourceLoader {
    ...
    public String getAppFunctionType() {
        return AppFunctionType.MessageTemplate;
    }
    ...
    public List<AppFunctionSource> getAppFunctionSources() {
        ...
        List<MessageTemplate> messageTemplates = this.dao.getAll(MessageTemplate.class);
        for (MessageTemplate messageTemplate : messageTemplates) {
            appFunctionSources.add(convert2AppFunctionSource(messageTemplate));
        }
    ...
    public <ITEM extends Serializable> AppFunctionSource convert2AppFunctionSource(ITEM item) {
        MessageTemplate messageTemplate = (MessageTemplate) item;
        String uuid = messageTemplate.getUuid();
        String fullName = messageTemplate.getName() + "_" + messageTemplate.getId();
        String name = "消息模板_" + messageTemplate.getName();
        String id = messageTemplate.getId();
        String code = messageTemplate.getCode();
