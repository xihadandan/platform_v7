 ...
 * 修改记录:
 * 修改后版本	修改人		修改日期			修改内容
 * 2016年5月10日.1	zhongzh		2016年5月10日		Create
 * </pre>
 * @date 2016年5月10日
 */
@Component
public class NoneComponent extends UIDesignComponent {
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_none.id", "widget_none");
