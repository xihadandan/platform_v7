...
/**
 * Description: 数据库表BUSINESS_ROLE的DAO接口实现类
 *
 * @author leo
 * @version 1.0
 *
 ...
 */
@Repository
public class BusinessRoleDaoImpl extends AbstractJpaDaoImpl<BusinessRoleEntity, String> implements BusinessRoleDao {
