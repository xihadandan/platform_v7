 ...
 * @date 2017年10月12日
 */
public class TestMapperBuilder1 extends TestMapperBuilder {
    ...
    public MappingFileData build(final String mapId) {
        ...
        BeanMappingBuilder mappingBuilder = new BeanMappingBuilder() {
            protected void configure() {
                ...
                try {
                    TypeDefinition typeA = TestMapperBuilder1.this.type(uriA, mapId);
                    TypeDefinition typeB = TestMapperBuilder1.this.type(uriB, mapId);
                    ...
                    for (Map<String, String> fieldMapping : fieldMappings) {
                        ...
                        FieldDefinition fieldA = TestMapperBuilder1.this.field(a, typeA, uriA);
                        FieldDefinition fieldB = TestMapperBuilder1.this.field(b, typeB, uriB);
