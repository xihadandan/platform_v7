 ...
 */
@Service
public class ExcelExportColumnDefinitionServiceImpl extends
        AbstractJpaServiceImpl<ExcelExportColumnDefinition, ExcelExportColumnDefinitionDao, String> implements
        ExcelExportColumnDefinitionService {
