 ...
 * @date 2018年4月20日
 */
public interface DataDictionaryAttributeService extends
        JpaService<DataDictionaryAttribute, DataDictionaryAttributeDao, String> {

    /**
     * @param attribute
     */
    void evict(DataDictionaryAttribute attribute);
