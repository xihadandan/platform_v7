 ...
 */
package com.wellsoft.pt.basicdata.documentlink.dao.impl;
 ...
 */
@Repository
public class CdDocumentLinkDaoImpl extends AbstractJpaDaoImpl<CdDocumentLinkEntity, String>
        implements CdDocumentLinkDao {
