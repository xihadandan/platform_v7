 ...
 */
@Component
public class WorkFlowOverDataSource extends AbstractDataSourceProvider {
    ...
    public Collection<DataSourceColumn> getAllDataSourceColumns() {
        ...
        DataSourceColumn flowInstanceEndTime = new DataSourceColumn();
        flowInstanceEndTime.setFieldName("flowInstance.endTime");
        flowInstanceEndTime.setColumnName("endTime");
        flowInstanceEndTime.setColumnAliase("endTime");
        flowInstanceEndTime.setTitleName("流程.结束时间");
        dataSourceColumns.add(flowInstanceEndTime);
        ...
        endTime.setFieldName("flowInstance.dueTime");
