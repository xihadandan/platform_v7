...
/**
 * Description: 数据库表BUSINESS_APPLICATION的DAO接口实现类
 *
 * @author leo
 * @version 1.0
 *
 ...
 */
@Repository
public class BusinessApplicationDaoImpl extends AbstractJpaDaoImpl<BusinessApplicationEntity, String> implements BusinessApplicationDao {
