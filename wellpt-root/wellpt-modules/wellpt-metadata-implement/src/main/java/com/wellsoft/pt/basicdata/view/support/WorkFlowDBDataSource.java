 ...
 */
@Component
public class WorkFlowDBDataSource extends AbstractDataSourceProvider {
    ...
    public Collection<DataSourceColumn> getAllDataSourceColumns() {
        ...
        dueTime.setFieldName("flowInstance.dueTime");
    ...
    public List<QueryItem> query(Set<DataSourceColumn> dataSourceColumn, String whereHql,
        ...
        if (StringUtils.isNotBlank(orderBy)) {
            ...
            for (String string : orderBys) {
                ...
                if (string.indexOf("dueTime") > -1) {
                    if (string.indexOf("desc") > -1) {
                        aclQueryInfo.addOrderby("flowInstance.dueTime desc");
                    } else if (string.indexOf("asc") > -1) {
        ...
        List<QueryItem> queryItems = aclService.queryForItem(TaskInstance.class, aclQueryInfo, AclPermission.SUPERVISE,
