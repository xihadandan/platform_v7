...
/**
 * Description: 数据库表BUSINESS_APPLICATION_CONFIG的DAO接口实现类
 *
 * @author leo
 * @version 1.0
 *
 ...
 */
@Repository
public class BusinessApplicationConfigDaoImpl extends AbstractJpaDaoImpl<BusinessApplicationConfigEntity, String> implements BusinessApplicationConfigDao {
