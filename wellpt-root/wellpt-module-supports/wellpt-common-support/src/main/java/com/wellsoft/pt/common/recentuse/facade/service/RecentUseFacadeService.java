 ...
 */
package com.wellsoft.pt.common.recentuse.facade.service;
 ...
 * @date 2018年6月15日
 */
public interface RecentUseFacadeService extends BaseService {
     ...
     */
    <ITEM extends BaseQueryItem> List<ITEM> queryRecentUseList(String userId, String moduleId, Class<ITEM> itmeClass,
                                                               List<String> queryProperties, String objectIdInItemProperty, List<String> ignoreProperties);
