...
package com.wellsoft.pt.security.interfaces.filter;
 ...
 */
public class SwitchTenantUserFilter extends GenericFilterBean implements ApplicationEventPublisherAware,
        MessageSourceAware {
    ...
    public static final String SPRING_SECURITY_SWITCH_TENANT_KEY = "j_switch_tenant";
        ...
        if (requiresSwitchUser(request)) {
            ...
            try {
                ...
                request.setAttribute(LoginAuthenticationProcessingFilter.SPRING_SECURITY_FORM_TENANT_KEY,
                        request.getParameter(SPRING_SECURITY_SWITCH_TENANT_KEY));
                request.setAttribute(SPRING_SECURITY_SWITCH_TENANT_KEY,
                        request.getParameter(SPRING_SECURITY_SWITCH_TENANT_KEY));
                ...
                request.removeAttribute(LoginAuthenticationProcessingFilter.SPRING_SECURITY_FORM_TENANT_KEY);
                request.removeAttribute(SPRING_SECURITY_SWITCH_TENANT_KEY);
            }
    ...
    protected Authentication attemptSwitchUser(HttpServletRequest request) throws AuthenticationException {
        ...
        if (this.eventPublisher != null) {
            eventPublisher.publishEvent(new AuthenticationSwitchUserEvent(SecurityContextHolder.getContext()
                    .getAuthentication(), targetUser));
        }
    ...
    /**
     * @return the switchUserUrl
     */
    public String getSwitchUserUrl() {
        return switchUserUrl;
    }
