 ...
 */
@Entity
@Table(name = "msg_message_content")
@DynamicUpdate
@DynamicInsert
public class MessageContent extends IdEntity {
    ...
    /**
     * messageOutbox 的messageid
     */
    private String outboxMsgId;
    ...
    public String getOutboxMsgId() {
        return outboxMsgId;
    }

    public void setOutboxMsgId(String outboxMsgId) {
