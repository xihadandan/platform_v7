 ...
 * @date 6/13/25
 */
public interface FulltextSettingService extends JpaService<FulltextSettingEntity, FulltextSettingDao, Long> {
    FulltextSettingEntity getByTypeAndSystem(String type, String system);
