package com.wellsoft.pt.org.util;
...
public class OrgUtil {
     ...
     * @return
     */
    public static User findLeaders(UserService userService, JobService jobService, String leadername) {
     ...
     */
	/*
	public static TreeNode getCategoryRoleTree(DataDictionary dataDictionaryDao, Set<Role> userRoles,
		List<Role> roles) {
	...
	DataDictionary category = dataDictionaryDao.getByType(categoryType);
	if (category == null) {
		return null;
	}
	String categoryUuid = category.getUuid();// "f304594f-8c59-4aa5-bf40-e7f19764644e"
	// 构建权限资源树
	List<QueryItem> allResources = dataDictionaryDao.query(QUERY_FOR_CATEGORYPRIVILEGE_TREE,
