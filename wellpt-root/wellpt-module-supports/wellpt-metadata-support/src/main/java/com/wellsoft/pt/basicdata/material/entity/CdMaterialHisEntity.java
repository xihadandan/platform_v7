...
@ApiModel("业务材料")
@Entity
@Table(name = "CD_MATERIAL_HIS")
@DynamicUpdate
@DynamicInsert
public class CdMaterialHisEntity extends com.wellsoft.context.jdbc.entity.Entity {

    @ApiModelProperty("业务材料数据UUID")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long bizMaterialUuid;
    ...
    /**
     * @return the bizMaterialUuid
     */
    public Long getBizMaterialUuid() {
        return bizMaterialUuid;
    }

    /**
     * @param bizMaterialUuid 要设置的bizMaterialUuid
     */
    public void setBizMaterialUuid(Long bizMaterialUuid) {
        this.bizMaterialUuid = bizMaterialUuid;
    }
