...
@ApiModel("材料定义")
@Entity
@Table(name = "CD_MATERIAL_DEFINITION_HIS")
@DynamicUpdate
@DynamicInsert
public class CdMaterialDefinitionHisEntity extends SysEntity {
    private static final long serialVersionUID = 1648284919982349340L;
