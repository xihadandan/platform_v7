...
public class ColumnDefinitionNew extends IdEntity {
    ...
    private String dataDictName;//列定义为数据字典时存下的数据字典名称

    private String dataDictValue;//列定义为数据字典时存下的数据字典的类型

    private Boolean joinQuery;// 列是否参与搜索
    @UnCloneable
    ...
    /**
     * @param dataDictName 要设置的dataDictName
     */
    ...
    /**
     * @param dataDictValue 要设置的dataDictValue
     */
