 ...
 * @date 2015-6-25
 */
public class SameDeptOfExpression extends WorkFlowExpression {
     ...
     * @param expression
     */
    public SameDeptOfExpression(String expression) {
        this.expression = expression;
        this.paramExpression = parseOptionOf(expression, Participant.SameDeptOf.name());
    }
    ...
    public Object evaluate(Param param) {
        return evaluate(param, Participant.SameDeptOf, paramExpression);
    }
