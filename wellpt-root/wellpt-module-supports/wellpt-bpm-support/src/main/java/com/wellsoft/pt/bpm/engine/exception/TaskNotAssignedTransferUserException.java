 ...
 * @date 2013-3-8
 */
public class TaskNotAssignedTransferUserException extends WorkFlowException {
     ...
     * @param variables
     */
    public TaskNotAssignedTransferUserException(Map<String, Object> variables) {
     ...
     * @param token
     */
    public TaskNotAssignedTransferUserException(Map<String, Object> variables, Token token) {
        this.variables = variables;
    ...
    public JsonDataErrorCode getErrorCode() {
        return JsonDataErrorCode.TaskNotAssignedTransferUser;
    }
