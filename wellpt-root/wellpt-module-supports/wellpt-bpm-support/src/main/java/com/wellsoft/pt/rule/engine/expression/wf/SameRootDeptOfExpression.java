 ...
 * @date 2015-6-25
 */
public class SameRootDeptOfExpression extends WorkFlowExpression {
     ...
     * @param expression
     */
    public SameRootDeptOfExpression(String expression) {
        this.expression = expression;
        this.paramExpression = parseOptionOf(expression, Participant.SameRootDeptOf.name());
    }
    ...
    public Object evaluate(Param param) {
        return evaluate(param, Participant.SameRootDeptOf, paramExpression);
    }
