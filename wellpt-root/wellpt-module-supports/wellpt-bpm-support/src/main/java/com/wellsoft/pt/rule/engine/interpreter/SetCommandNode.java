...
import com.wellsoft.pt.rule.engine.executor.SetExecutor;
 ...
 * @date 2015-6-24
 */
public class SetCommandNode extends Node {
    private String name;
    ...
    public void parse(Context context) throws ParseException {
        ...
        executor = new SetExecutor();// context.createExecutor(name);
    }
    ...
    public Result execute(Param param) throws ExecuteException {
        ...
        logger.debug("start execute SetCommondNode at level " + level);
        ...
        logger.debug("over execute SetCommondNode at level " + level);
    ...
    public String toString() {
        return "[set " + expression.toString() + " end]";
    }
