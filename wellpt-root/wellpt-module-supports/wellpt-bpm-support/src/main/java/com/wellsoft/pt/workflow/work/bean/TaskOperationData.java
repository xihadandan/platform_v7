 ...
 * @date 2019年3月8日
 */
public class TaskOperationData extends BaseObject {

    /**
     * 如何描述serialVersionUID
     */
    private static final long serialVersionUID = -8443162668216987096L;
    ...
    // 信息分发
    private List<TaskOperationBean> operations = Lists.newArrayListWithCapacity(0);
    ...
    /**
     * @param operations 要设置的operations
     */
    public void setOperations(List<TaskOperationBean> operations) {
