 ...
 * @date 2015-6-25
 */
public class DeptOfExpression extends WorkFlowExpression {
     ...
     * @param tmp
     */
    public DeptOfExpression(String expression) {
        this.expression = expression;
        this.paramExpression = parseOptionOf(expression, Participant.DeptOf.name());
    }
    ...
    public Object evaluate(Param param) {
        return evaluate(param, Participant.DeptOf, paramExpression);
    }
