 ...
 * @date 2013-3-8
 */
public class TaskNotAssignedMonitorException extends WorkFlowException {
     ...
     * @param variables
     */
    public TaskNotAssignedMonitorException(Map<String, Object> variables) {
     ...
     * @param token
     */
    public TaskNotAssignedMonitorException(Map<String, Object> variables, Token token) {
        this.variables = variables;
    ...
    public JsonDataErrorCode getErrorCode() {
        return JsonDataErrorCode.TaskNotAssignedMonitor;
    }
