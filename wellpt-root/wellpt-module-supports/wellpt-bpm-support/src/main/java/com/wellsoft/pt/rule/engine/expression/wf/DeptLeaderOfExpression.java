 ...
 * @date 2015-6-25
 */
public class DeptLeaderOfExpression extends WorkFlowExpression {
     ...
     * @param expression
     */
    public DeptLeaderOfExpression(String expression) {
        this.expression = expression;
        this.paramExpression = parseOptionOf(expression, Participant.DeptLeaderOf.name());
    }
    ...
    public Object evaluate(Param param) {
        return evaluate(param, Participant.DeptLeaderOf, paramExpression);
    }
