...
/**
 * Description: 数据库表WF_FLOW_INSPECTION_FILE_RECORD的DAO接口
 *
 * @author zenghw
 * @version 1.0
 *
 ...
 * @date 2021-08-25
 */
public interface WfFlowInspectionFileRecordDao extends JpaDao<WfFlowInspectionFileRecordEntity, String> {
