...
@Entity
@CommonEntity
@Table(name = "WF_GZ_DATA_SYNC_HIS")
@DynamicUpdate
@DynamicInsert
public class WfGzDataSyncHis extends IdEntity {

    /**
     * 如何描述serialVersionUID
     */
    private static final long serialVersionUID = 1437101649659L;
    ...
    public String getTargetFlowInstUuid() {
        return this.targetFlowInstUuid;
    }

    /**
     * @param targetFlowInstUuid
     */
    public String setTargetFlowInstUuid(String targetFlowInstUuid) {
        return this.targetFlowInstUuid = targetFlowInstUuid;
    }
