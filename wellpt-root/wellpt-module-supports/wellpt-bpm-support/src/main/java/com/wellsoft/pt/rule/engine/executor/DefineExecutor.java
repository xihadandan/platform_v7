 ...
 * @date 2015-6-24
 */
public class DefineExecutor extends AbstractExecutor {
    ...
    public Result execute(Param param) throws ExecuteException {
        ...
        String varName = getVarName(exp.toString());
        context.defineVar(level, varName);
        context.exeExpression(exp.toString());
        logger.debug("define " + exp + " at leve " + level);
        return result;
    }
