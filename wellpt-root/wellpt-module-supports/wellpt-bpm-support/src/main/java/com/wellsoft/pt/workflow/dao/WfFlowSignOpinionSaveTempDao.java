...
/**
 * Description: 数据库表WF_FLOW_SIGN_OPINION_SAVE_TEMP的DAO接口
 *
 * @author zenghw
 * @version 1.0
 *
 ...
 * @date 2021-09-10
 */
public interface WfFlowSignOpinionSaveTempDao extends JpaDao<WfFlowSignOpinionSaveTempEntity, String> {
