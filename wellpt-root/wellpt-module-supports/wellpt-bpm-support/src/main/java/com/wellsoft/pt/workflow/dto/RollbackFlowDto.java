 ...
 */
@ApiModel("手写签批退回对象")
public class RollbackFlowDto implements Serializable {
    ...
    @ApiModelProperty("退回类型（1:退回，2:直接退回）")
    ...
    public void setRollbackType(final Integer rollbackType) {
