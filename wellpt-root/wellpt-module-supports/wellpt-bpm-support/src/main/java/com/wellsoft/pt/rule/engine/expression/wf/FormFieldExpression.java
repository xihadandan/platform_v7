 ...
 * @date 2015-6-25
 */
public class FormFieldExpression extends WorkFlowExpression {
     ...
     * @param tmp
     */
    public FormFieldExpression(String expression) {
    ...
    public Object evaluate(Param param) {
        ...
        List<String> formFields = getParamAsList(this.expression, CommandName.FormField);
        List<FlowUserSid> userIds = formFieldIdentityResolver
                .resolve(node, token, formFields, ParticipantType.TodoUser);
