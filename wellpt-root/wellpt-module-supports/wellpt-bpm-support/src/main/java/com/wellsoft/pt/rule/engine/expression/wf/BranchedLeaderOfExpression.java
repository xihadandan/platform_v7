 ...
 * @date 2015-6-25
 */
public class BranchedLeaderOfExpression extends WorkFlowExpression {
     ...
     * @param tmp
     */
    public BranchedLeaderOfExpression(String expression) {
        this.expression = expression;
        this.paramExpression = parseOptionOf(expression, Participant.BranchedLeaderOf.name());
    }
    ...
    public Object evaluate(Param param) {
        return evaluate(param, Participant.BranchedLeaderOf, paramExpression);
    }
