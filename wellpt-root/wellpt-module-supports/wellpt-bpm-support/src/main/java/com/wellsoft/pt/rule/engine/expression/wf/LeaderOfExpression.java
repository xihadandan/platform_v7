 ...
 * @date 2015-6-25
 */
public class LeaderOfExpression extends WorkFlowExpression {
     ...
     * @param tmp
     */
    public LeaderOfExpression(String expression) {
        this.expression = expression;
        this.paramExpression = parseOptionOf(expression, Participant.LeaderOf.name());
    }
    ...
    public Object evaluate(Param param) {
        return evaluate(param, Participant.LeaderOf, paramExpression);
    }
