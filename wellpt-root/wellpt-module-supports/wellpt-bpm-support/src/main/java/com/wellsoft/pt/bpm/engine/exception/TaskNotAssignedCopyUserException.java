 ...
 * @date 2013-3-8
 */
public class TaskNotAssignedCopyUserException extends WorkFlowException {
     ...
     * @param variables
     */
    public TaskNotAssignedCopyUserException(Map<String, Object> variables) {
     ...
     * @param token
     */
    public TaskNotAssignedCopyUserException(Map<String, Object> variables, Token token) {
        this.variables = variables;
