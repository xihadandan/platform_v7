 ...
 * @date 2013-3-8
 */
public class TaskNotAssignedUserException extends WorkFlowException {
     ...
     * @param variables
     */
    public TaskNotAssignedUserException(Map<String, Object> variables) {
     ...
     * @param token
     */
    public TaskNotAssignedUserException(Map<String, Object> variables, Token token) {
        this.variables = variables;
    ...
    public JsonDataErrorCode getErrorCode() {
        return JsonDataErrorCode.TaskNotAssignedUser;
    }
