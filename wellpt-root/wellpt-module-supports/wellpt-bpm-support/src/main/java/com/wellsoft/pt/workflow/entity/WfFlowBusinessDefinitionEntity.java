 ...
 * 修改记录:
 * 修改后版本	修改人		修改日期			修改内容
 * 11/10/22.1	zhulh		11/10/22		Create
 * </pre>
 * @date 11/10/22
 */
@ApiModel("流程业务定义")
@Entity
@Table(name = "WF_FLOW_BUSINESS_DEFINITION")
@DynamicUpdate
@DynamicInsert
public class WfFlowBusinessDefinitionEntity extends IdEntity {
    private static final long serialVersionUID = -8903063855879979795L;
