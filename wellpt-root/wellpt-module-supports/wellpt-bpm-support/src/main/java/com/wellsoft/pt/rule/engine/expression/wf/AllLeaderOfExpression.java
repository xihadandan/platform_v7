 ...
 * @date 2015-6-25
 */
public class AllLeaderOfExpression extends WorkFlowExpression {
     ...
     * @param expression
     */
    public AllLeaderOfExpression(String expression) {
        this.expression = expression;
        this.paramExpression = parseOptionOf(expression, Participant.AllLeaderOf.name());
    }
    ...
    public Object evaluate(Param param) {
        return evaluate(param, Participant.AllLeaderOf, paramExpression);
    }
