 ...
 * @date 2013-3-8
 */
public class TaskNotAssignedAddSignUserException extends WorkFlowException {
     ...
     * @param variables
     */
    public TaskNotAssignedAddSignUserException(Map<String, Object> variables) {
     ...
     * @param token
     */
    public TaskNotAssignedAddSignUserException(Map<String, Object> variables, Token token) {
        this.variables = variables;
    ...
    public JsonDataErrorCode getErrorCode() {
        return JsonDataErrorCode.TaskNotAssignedAddSignUser;
    }
