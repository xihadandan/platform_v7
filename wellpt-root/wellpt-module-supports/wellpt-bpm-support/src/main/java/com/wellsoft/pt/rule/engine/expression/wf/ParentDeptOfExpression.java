 ...
 * @date 2015-6-25
 */
public class ParentDeptOfExpression extends WorkFlowExpression {
     ...
     * @param expression
     */
    public ParentDeptOfExpression(String expression) {
        this.expression = expression;
        this.paramExpression = parseOptionOf(expression, Participant.ParentDeptOf.name());
    }
    ...
    public Object evaluate(Param param) {
        return evaluate(param, Participant.ParentDeptOf, paramExpression);
    }
