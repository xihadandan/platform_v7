 ...
 * @date 2013-4-7
 */
public class RollbackTaskNotFoundException extends WorkFlowException {
    private static final long serialVersionUID = -4195086242470342689L;

    private Map<String, Object> variables;

    public RollbackTaskNotFoundException(Map<String, Object> variables) {
    ...
    public JsonDataErrorCode getErrorCode() {
        return JsonDataErrorCode.RollbackTaskNotFound;
    }
