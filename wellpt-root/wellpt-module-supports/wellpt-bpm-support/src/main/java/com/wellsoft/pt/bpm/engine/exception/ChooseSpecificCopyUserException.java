 ...
 * @date 2014-5-27
 */
public class ChooseSpecificCopyUserException extends ChooseSpecificUserException {

    /**
     * 如何描述serialVersionUID
     */
    private static final long serialVersionUID = -9103064518060654591L;
     ...
     * @param unitElements
     */
    public ChooseSpecificCopyUserException(Node node, Token token, String taskName, String taskId, Collection<FlowUserSid> userIds,
                                           String submitButtonId, List<Map<String, String>> users, List<UserUnitElement> unitElements) {
    ...
    public JsonDataErrorCode getErrorCode() {
        return JsonDataErrorCode.TaskNotAssignedCopyUser;
    }
