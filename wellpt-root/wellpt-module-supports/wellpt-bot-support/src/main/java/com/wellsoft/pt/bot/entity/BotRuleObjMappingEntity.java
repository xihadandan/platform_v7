...
/**
 * Description: 数据库表BOT_RULE_OBJ_MAPPING的实体类
 *
 * @author chenq
 * @version 1.0
 *
 ...
 */
@Entity
@Table(name = "BOT_RULE_OBJ_MAPPING")
@DynamicUpdate
@DynamicInsert
public class BotRuleObjMappingEntity extends TenantEntity {

    public final static Integer VAL_TYPE_FTL = new Integer(0);
    public final static Integer VAL_TYPE_GROOVY = new Integer(1);
