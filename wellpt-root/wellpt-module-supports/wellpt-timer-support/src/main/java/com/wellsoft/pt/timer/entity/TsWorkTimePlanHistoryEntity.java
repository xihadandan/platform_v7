 ...
 */
@Entity
@Table(name = "TS_WORK_TIME_PLAN_HIS")
@DynamicUpdate
@DynamicInsert
@ApiModel("工作时间方案历史")
public class TsWorkTimePlanHistoryEntity extends TenantEntity {

    /**
     * 如何描述serialVersionUID
     */
    private static final long serialVersionUID = 6751841672438707246L;

    // 工作时间方案UUID
    @ApiModelProperty("工作时间方案UUID")
