 ...
 * 官方下载地址：http://commons.apache.org/proper/commons-codec/download_codec.cgi
 */
package com.wellsoft.pt.app.weixin.support.aes;
...
public class WXBizJsonMsgCrypt {
    ...
    public String EncryptMsg(String replyMsg, String timeStamp, String nonce) throws AesException {
        ...
        // 生成发送的json
        String result = StringUtils.startsWith(encrypt, "{") ? JsonParse.generate(encrypt, signature, timeStamp, nonce) : XMLParse.generate(encrypt, signature, timeStamp, nonce);
        return result;
    }
    ...
    public String DecryptMsg(String msgSignature, String timeStamp, String nonce, String postData)
        ...
        // 密钥，公众账号的app secret
        // 提取密文
        Object[] encrypt = StringUtils.startsWith(postData, "{") ? JsonParse.extract(postData) : XMLParse.extract(postData);
