 ...
 */
package com.wellsoft.pt.app.personal.document.config.component;
 ...
 */
@Component
public class PersonalDocumentComponent extends UIDesignComponent {
    ...
    public JavaScriptModule getJavaScriptModule() {
        String id = Config.getValue("pt.js.module.widget_personal_document.id", "widget_personal_document");
