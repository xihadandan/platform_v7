 ...
 */
package com.wellsoft.pt.app.personalinfo;
 ...
 * 修改记录:
 * 修改后版本	修改人		修改日期			修改内容
 * Jan 24, 2017.1	zhulh		Jan 24, 2017		Create
 * </pre>
 * @date Jan 24, 2017
 */
@Configuration
public class PersonalInfoWebAppConfig extends AppContextConfigurerAdapter {
    ...
    public void addProperties(PropertiesRegistry propertiesRegistry) {
        propertiesRegistry.registerProperties("pt-app-personal-info.properties");
    }
