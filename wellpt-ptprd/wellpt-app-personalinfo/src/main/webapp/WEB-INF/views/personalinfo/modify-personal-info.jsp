    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <label class="radio-inline"> <input type="radio" name="sex" value="1"
                ...
                男
            </label> <label class="radio-inline"> <input type="radio" name="sex" value="2"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="hidden" class="form-control" name="photoUuid" value="${user.photoUuid}"/> <img
                class="img-responsive img-rounded pull-left" id="personalInfoPhotoImage"
                src="${ctx}/org/user/view/photo/${user.photoUuid}"
