 ...
 */
@Component
public class FlowHandleOverdueOfAvgByDeptEchartDatasetLoad implements EchartDatasetLoad {
    ...
    public List<Dataset> loadDataset(Map<String, Object> params) {
        ...
        List<QueryItem> queryItems = flowHandleOverdueReportService.queryAvgOverdueTimeByDeptGroupByDept(deptIds, Maps.newHashMap(params), new PagingInfo(1, maxBarCount));
