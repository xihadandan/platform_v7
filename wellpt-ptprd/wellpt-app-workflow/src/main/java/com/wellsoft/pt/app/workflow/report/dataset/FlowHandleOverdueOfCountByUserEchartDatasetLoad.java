 ...
 */
@Component
public class FlowHandleOverdueOfCountByUserEchartDatasetLoad implements EchartDatasetLoad {
    ...
    public List<Dataset> loadDataset(Map<String, Object> params) {
        ...
        List<QueryItem> queryItems = flowHandleOverdueReportService.queryOverdueCountByUserGroupByUser(Maps.newHashMap(params), new PagingInfo(1, maxBarCount));
