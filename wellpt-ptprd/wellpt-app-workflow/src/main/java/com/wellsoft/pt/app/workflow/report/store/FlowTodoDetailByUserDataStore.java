 ...
 */
@Component
public class FlowTodoDetailByUserDataStore extends AbstractDataStoreQueryInterface {
    ...
    public String getQueryName() {
        return "流程统计分析_待办流程分析按人员_待办详情列表";
    }

    @Override
    public CriteriaMetadata initCriteriaMetadata(QueryContext context) {
        CriteriaMetadata criteriaMetadata = CriteriaMetadata.createMetadata();
        criteriaMetadata.add("uuid", "t.uuid", "待办标识UUID", String.class);
    ...
    public List<QueryItem> query(QueryContext context) {
        ...
        List<QueryItem> queryItems = context.getNativeDao().namedQuery("listFlowTodoDetailByUserQuery", queryParams, QueryItem.class, context.getPagingInfo());
        return queryItems;
    }

    private Map<String, Object> getQueryParams(QueryContext context) {
        Map<String, Object> queryParams = context.getQueryParams();
        String userId = Objects.toString(queryParams.get("userId"), org.apache.commons.lang.StringUtils.EMPTY);
