 ...
 * 修改记录:
 * 修改后版本		修改人		修改日期			修改内容
 * 7/11/25.1	    zhulh		7/11/25		    Create
 * </pre>
 * @date 7/11/25
 */
@Component
public class FlowEfficiencyAvgTaskDurationDataStore extends AbstractDataStoreQueryInterface {
    ...
    public List<QueryItem> query(QueryContext context) {
        ...
        List<QueryItem> queryItems = context.getNativeDao().namedQuery("listTaskAverageDurationQuery", queryParams, QueryItem.class, context.getPagingInfo());
