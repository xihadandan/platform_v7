 ...
 */
@Component
public class FlowEfficiencyDetailTaskDurationDataStore extends AbstractDataStoreQueryInterface {
    ...
    public String getQueryName() {
        return "流程统计分析_流程效率分析_环节用时详细统计表";
    }
    ...
    public List<QueryItem> query(QueryContext context) {
        ...
        List<QueryItem> queryItems = context.getNativeDao().namedQuery("listTaskDurationDetailQuery", queryParams, QueryItem.class, context.getPagingInfo());
