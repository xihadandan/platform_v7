 ...
 */
@Component
public class FlowHandleOverdueDetailByDeptDataStore extends FlowHandleOverdueOfAvgByDeptDataStore {

    @Override
    public String getQueryName() {
        return "流程统计分析_办理逾期分析_部门逾期明细";
    }
    ...
    public List<QueryItem> query(QueryContext context) {
        ...
        List<QueryItem> queryItems = context.getNativeDao().namedQuery("flowHandleOverdueDetailByDeptQuery",
