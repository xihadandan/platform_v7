...
@Service
@Deprecated
public class MultiOrgSyncUserLogServiceImpl extends AbstractJpaServiceImpl<MultiOrgSyncUserLog, MultiOrgSyncUserLogDao, String> implements MultiOrgSyncUserLogService {
    ...
    public boolean isExistsErrorData(String logId) {
        ...
        return dao.countByEntity(log) > 0;
    }
}
