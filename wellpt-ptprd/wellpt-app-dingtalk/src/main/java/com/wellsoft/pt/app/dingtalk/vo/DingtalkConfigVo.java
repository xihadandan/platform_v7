 ...
 * @date 4/17/25
 */
public class DingtalkConfigVo extends BaseObject {

    private static final long serialVersionUID = -7819254336120568715L;
     ...
     */
    public DingtalkConfiguration getConfiguration() {
     ...
     */
    public void setConfiguration(DingtalkConfiguration configuration) {
     ...
     * @return
     */
    public static DingtalkConfigVo fromEntity(DingtalkConfigEntity entity) {
        DingtalkConfigVo vo = new DingtalkConfigVo();
        if (entity != null) {
            BeanUtils.copyProperties(entity, vo);
            if (StringUtils.isNotBlank(entity.getDefinitionJson())) {
                vo.setConfiguration(JsonUtils.json2Object(entity.getDefinitionJson(), DingtalkConfiguration.class));
            }
        }
        return vo;
    }
    ...
    public static final class DingtalkConfiguration extends BaseObject {
        private Boolean enabledSyncOrg;

        private String orgUuid;

        private DingtalkOrgSyncOption orgSyncOption;
        ...
        // 待办任务
        private boolean enabledTodoTask;

        // 事项群聊
        private DingtalkGroupChat groupChat;
         ...
         */
        public DingtalkOrgSyncOption getOrgSyncOption() {
         ...
         */
        public void setOrgSyncOption(DingtalkOrgSyncOption orgSyncOption) {
        ...
        /**
         * @return the enabledTodoTask
         */
        public boolean isEnabledTodoTask() {
            return enabledTodoTask;
        }

        /**
         * @param enabledTodoTask 要设置的enabledTodoTask
         */
        public void setEnabledTodoTask(boolean enabledTodoTask) {
            this.enabledTodoTask = enabledTodoTask;
        }

        /**
         * @return the groupChat
         */
        public DingtalkGroupChat getGroupChat() {
            return groupChat;
        }
         ...
         */
        public void setGroupChat(DingtalkGroupChat groupChat) {
            this.groupChat = groupChat;
        }
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class DingtalkOrgSyncOption extends BaseObject {
        ...
        // 职位同步方式，first第一个加入的部门、last最后一个加入的部门、all所有部门
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class DingtalkGroupChat extends BaseObject {
        ...
        /**
         * @param useTemplate 要设置的useTemplate
         */
