...
@Table(name = "dingtalk_sync_log_detail")
@DynamicUpdate
@DynamicInsert
public class DingtalkSyncLogDetailEntity extends SysEntity {
    private static final long serialVersionUID = 5085286960982568522L;
    ...
    // 目标表：部门表：dingtalk_dept、职位表：dingtalk_job、用户表：dingtalk_user
