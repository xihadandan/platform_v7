define(["jquery", "commons", "constant", "server", "ListViewWidgetDevelopment", "appModal", "wSelect2Group"], function ($, commons, constant, server, ListViewWidgetDevelopment, appModal) {
    var JDS = server.JDS;
