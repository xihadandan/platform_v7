...
/**
 * Description: 数据库表APP_BASE_CALENDAR_EVENT的DAO接口实现类
 *
 * @author shenhb
 * @version 1.0
 *
 ...
 */
@Repository
public class AppBaseCalendarEventDaoImpl extends AbstractJpaDaoImpl<AppBaseCalendarEventEntity, String> implements AppBaseCalendarEventDao {
